...
struct dentry *lookup_dentry(char *path, struct vfsmount **mntp = 0);
...
struct dentry *lookup_dentry(char *path, struct vfsmount **mntp)
{
    ...
    struct dentry *dentry;
    struct qstr q;
    char buf[256], *path2, *name;
    struct vfsmount *mnt;
    struct mount *m;

    task = ({typeof (*(&init_task)->tasks.next) *__ptr = (typeof (*(&init_task)->tasks.next) *)(&init_task)->tasks.next; ({ typeof( ((struct task_struct *)0)->tasks ) *__mptr = ((typeof((&init_task)->tasks.next))(__ptr)); (struct task_struct *)( (char *)__mptr - ((size_t) &((struct task_struct *)0)->tasks) );}); });
...
extern int cp_new_stat(struct kstat *stat, struct stat *statbuf);
...
void get_dir_cache(struct dentry *dentry, struct strset *ss)
{
    ...
    for (child = ({ typeof( ((typeof(*child) *)0)->d_u.d_child ) *__mptr = ((&dentry->d_subdirs)->next); (typeof(*child) *)( (char *)__mptr - ((size_t) &((typeof(*child) *)0)->d_u.d_child) );}); &child->d_u.d_child != (&dentry->d_subdirs); child = ({ typeof( ((typeof(*(child)) *)0)->d_u.d_child ) *__mptr = ((child)->d_u.d_child.next); (typeof(*(child)) *)( (char *)__mptr - ((size_t) &((typeof(*(child)) *)0)->d_u.d_child) );})) {
