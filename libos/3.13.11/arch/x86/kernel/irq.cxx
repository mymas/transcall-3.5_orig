...
static inline char* of_node_full_name(struct device_node *np)
{
 return "<no-node>";
}
...
static inline struct device_node *of_get_parent( struct device_node *node)
{
 return 0;
}
...
static inline int of_get_child_count( struct device_node *np)
{
 return 0;
}
...
static inline int of_device_is_compatible( struct device_node *device,
       char *name)
{
 return 0;
}

static inline int of_device_is_available( struct device_node *device)
{
 return 0;
}
...
static inline int of_property_read_u32_index( struct device_node *np,
   char *propname, u32 index, u32 *out_value)
{
 return -38;
}

static inline int of_property_read_u8_array( struct device_node *np,
   char *propname, u8 *out_values, size_t sz)
{
 return -38;
}

static inline int of_property_read_u16_array( struct device_node *np,
   char *propname, u16 *out_values, size_t sz)
{
 return -38;
}
...
static inline void *of_get_property( struct device_node *node,
    char *name,
    int *lenp)
{
 return 0;
...
static inline int of_property_read_u64( struct device_node *np,
           char *propname, u64 *out_value)
{
 return -38;
}
...
static inline int of_parse_phandle_with_fixed_args( struct device_node *np,
 char *list_name, int cells_count, int index,
 struct of_phandle_args *out_args)
{
 return -38;
}
...
static inline int of_alias_get_id(struct device_node *np, char *stem)
{
 return -38;
}

static inline int of_machine_is_compatible( char *compat)
{
 return 0;
}
...
static inline __be32 *of_prop_next_u32(struct property *prop,
  __be32 *cur, u32 *pu)
{
 return 0;
}

static inline char *of_prop_next_string(struct property *prop,
  char *cur)
{
 return 0;
}
...
static inline bool of_property_read_bool( struct device_node *np,
      char *propname)
{
 struct property *prop = of_find_property(np, propname, 0);

 return prop ? _true : _false;
}

static inline int of_property_read_u8( struct device_node *np,
           char *propname,
           u8 *out_value)
{
...
extern __attribute__((section(".data..percpu" ""))) __typeof__(struct device *) mce_device;
...
extern __attribute__((section(".data..percpu" ""))) __typeof__(unsigned) mce_exception_count;
extern __attribute__((section(".data..percpu" ""))) __typeof__(unsigned) mce_poll_count;

extern atomic_t mce_entry;

typedef unsigned long mce_banks_t[(((32) + (8 * sizeof(long)) - 1) / (8 * sizeof(long)))];
extern __attribute__((section(".data..percpu" ""))) __typeof__(mce_banks_t) mce_poll_banks;
...
extern __attribute__((section(".data..percpu" ""))) __typeof__(struct mce) injectm;
...
{
 u64 sum = (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->__nmi_count;


 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->apic_timer_irqs;
 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->irq_spurious_count;
 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->apic_perf_irqs;
 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->apic_irq_work_irqs;
 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->icr_read_retry_count;
 ...
 if (1)
  ...
  sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->x86_platform_ipis;

 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->irq_resched_count;
 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->irq_call_count;


 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->irq_thermal_count;


 sum += (&(*({ do { void *__vpp_verify = (typeof(((&(irq_stat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(irq_stat))) *)(&(irq_stat)))); (typeof((typeof(*(&(irq_stat))) *)(&(irq_stat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))->irq_threshold_count;
 ...
 sum += (*(typeof(({ do { void *__vpp_verify = (typeof(((&(mce_exception_count))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(mce_exception_count))) *)(&(mce_exception_count)))); (typeof((typeof(*(&(mce_exception_count))) *)(&(mce_exception_count)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))g_map(({ do { void *__vpp_verify = (typeof(((&(mce_exception_count))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(mce_exception_count))) *)(&(mce_exception_count)))); (typeof((typeof(*(&(mce_exception_count))) *)(&(mce_exception_count)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }), sizeof(*(({ do { void *__vpp_verify = (typeof(((&(mce_exception_count))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(mce_exception_count))) *)(&(mce_exception_count)))); (typeof((typeof(*(&(mce_exception_count))) *)(&(mce_exception_count)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))));
 sum += (*(typeof(({ do { void *__vpp_verify = (typeof(((&(mce_poll_count))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(mce_poll_count))) *)(&(mce_poll_count)))); (typeof((typeof(*(&(mce_poll_count))) *)(&(mce_poll_count)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))g_map(({ do { void *__vpp_verify = (typeof(((&(mce_poll_count))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(mce_poll_count))) *)(&(mce_poll_count)))); (typeof((typeof(*(&(mce_poll_count))) *)(&(mce_poll_count)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }), sizeof(*(({ do { void *__vpp_verify = (typeof(((&(mce_poll_count))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(mce_poll_count))) *)(&(mce_poll_count)))); (typeof((typeof(*(&(mce_poll_count))) *)(&(mce_poll_count)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })))));
