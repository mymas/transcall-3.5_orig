...
struct dentry *debugfs_create_file( char *name, umode_t mode,
       struct dentry *parent, void *data,
       struct file_operations *fops);

struct dentry *debugfs_create_dir( char *name, struct dentry *parent);

struct dentry *debugfs_create_symlink( char *name, struct dentry *parent,
          char *dest);
...
struct dentry *debugfs_create_u8( char *name, umode_t mode,
     struct dentry *parent, u8 *value);
struct dentry *debugfs_create_u16( char *name, umode_t mode,
      struct dentry *parent, u16 *value);
struct dentry *debugfs_create_u32( char *name, umode_t mode,
      struct dentry *parent, u32 *value);
struct dentry *debugfs_create_u64( char *name, umode_t mode,
      struct dentry *parent, u64 *value);
struct dentry *debugfs_create_x8( char *name, umode_t mode,
     struct dentry *parent, u8 *value);
struct dentry *debugfs_create_x16( char *name, umode_t mode,
      struct dentry *parent, u16 *value);
struct dentry *debugfs_create_x32( char *name, umode_t mode,
      struct dentry *parent, u32 *value);
struct dentry *debugfs_create_x64( char *name, umode_t mode,
      struct dentry *parent, u64 *value);
struct dentry *debugfs_create_size_t( char *name, umode_t mode,
         struct dentry *parent, size_t *value);
struct dentry *debugfs_create_atomic_t( char *name, umode_t mode,
         struct dentry *parent, atomic_t *value);
struct dentry *debugfs_create_bool( char *name, umode_t mode,
      struct dentry *parent, u32 *value);

struct dentry *debugfs_create_blob( char *name, umode_t mode,
      struct dentry *parent,
      struct debugfs_blob_wrapper *blob);

struct dentry *debugfs_create_regset32( char *name, umode_t mode,
         struct dentry *parent,
...
struct dentry *debugfs_create_u32_array( char *name, umode_t mode,
     struct dentry *parent,
...
static inline int uuid_le_cmp( uuid_le u1, uuid_le u2)
{
 return memcmp(&u1, &u2, sizeof(uuid_le));
}

static inline int uuid_be_cmp( uuid_be u1, uuid_be u2)
{
...
void __iowrite32_copy(void *to, void *from, size_t count);
void __iowrite64_copy(void *to, void *from, size_t count);
...
int check_signature( void *io_addr,
   unsigned char *signature, int length);
...
static inline char *pci_slot_name( struct pci_slot *slot)
{
...
extern char *pci_power_names[];

static inline char *pci_power_name(pci_power_t state)
{
...
struct resource *pci_find_parent_resource( struct pci_dev *dev,
       struct resource *res);
...
struct pci_bus *pci_find_next_bus( struct pci_bus *from);
...
struct pci_dev *pci_get_class(unsigned int _class, struct pci_dev *from);
int pci_dev_present( struct pci_device_id *ids);
...
static inline int pci_enable_wake(struct pci_dev *dev, pci_power_t state,
      bool enable)
{
 return __pci_enable_wake(dev, state, _false, enable);
}
...
ssize_t pci_write_vpd(struct pci_dev *dev, loff_t pos, size_t count, void *buf);
...
int pci_request_regions_exclusive(struct pci_dev *, char *);
void pci_release_regions(struct pci_dev *);
int pci_request_region(struct pci_dev *, int, char *);
int pci_request_region_exclusive(struct pci_dev *, int, char *);
...
struct resource *pci_bus_resource_n( struct pci_bus *bus, int n);
...
int pci_add_dynid(struct pci_driver *drv,
    ...
    unsigned int _class, unsigned int class_mask,
    unsigned long driver_data);
 struct pci_device_id *pci_match_id( struct pci_device_id *ids,
      struct pci_dev *dev);
...
struct dma_pool *dma_pool_create( char *name, struct device *dev,
...
struct dma_pool *dmam_pool_create( char *name, struct device *dev,
      size_t size, size_t align, size_t allocation);
...
{
 return dma_supported(hwdev == 0 ? 0 : &hwdev->dev, mask);
}
...
pci_alloc_consistent(struct pci_dev *hwdev, size_t size,
       dma_addr_t *dma_handle)
{
 return dma_alloc_attrs(hwdev == 0 ? 0 : &hwdev->dev,size,dma_handle,((( gfp_t)0x20u)),0);
}
...
pci_free_consistent(struct pci_dev *hwdev, size_t size,
      void *vaddr, dma_addr_t dma_handle)
{
 dma_free_attrs(hwdev == 0 ? 0 : &hwdev->dev,size,vaddr,dma_handle,0);
}

static inline dma_addr_t
pci_map_single(struct pci_dev *hwdev, void *ptr, size_t size, int direction)
{
 return dma_map_single_attrs(hwdev == 0 ? 0 : &hwdev->dev, ptr, size, (enum dma_data_direction)direction, 0);
}
...
pci_unmap_single(struct pci_dev *hwdev, dma_addr_t dma_addr,
   size_t size, int direction)
{
 dma_unmap_single_attrs(hwdev == 0 ? 0 : &hwdev->dev, dma_addr, size, (enum dma_data_direction)direction, 0);
}
...
{
 return dma_map_page(hwdev == 0 ? 0 : &hwdev->dev, page, offset, size, (enum dma_data_direction)direction);
}
...
pci_unmap_page(struct pci_dev *hwdev, dma_addr_t dma_address,
        size_t size, int direction)
{
 dma_unmap_page(hwdev == 0 ? 0 : &hwdev->dev, dma_address, size, (enum dma_data_direction)direction);
}
...
{
 return dma_map_sg_attrs(hwdev == 0 ? 0 : &hwdev->dev, sg, nents, (enum dma_data_direction)direction, 0);
}
...
pci_unmap_sg(struct pci_dev *hwdev, struct scatterlist *sg,
      int nents, int direction)
{
 dma_unmap_sg_attrs(hwdev == 0 ? 0 : &hwdev->dev, sg, nents, (enum dma_data_direction)direction, 0);
}
...
pci_dma_sync_single_for_cpu(struct pci_dev *hwdev, dma_addr_t dma_handle,
      size_t size, int direction)
{
 dma_sync_single_for_cpu(hwdev == 0 ? 0 : &hwdev->dev, dma_handle, size, (enum dma_data_direction)direction);
}
...
pci_dma_sync_single_for_device(struct pci_dev *hwdev, dma_addr_t dma_handle,
      size_t size, int direction)
{
 dma_sync_single_for_device(hwdev == 0 ? 0 : &hwdev->dev, dma_handle, size, (enum dma_data_direction)direction);
}
...
pci_dma_sync_sg_for_cpu(struct pci_dev *hwdev, struct scatterlist *sg,
  int nelems, int direction)
{
 dma_sync_sg_for_cpu(hwdev == 0 ? 0 : &hwdev->dev, sg, nelems, (enum dma_data_direction)direction);
}
...
pci_dma_sync_sg_for_device(struct pci_dev *hwdev, struct scatterlist *sg,
  int nelems, int direction)
{
 dma_sync_sg_for_device(hwdev == 0 ? 0 : &hwdev->dev, sg, nelems, (enum dma_data_direction)direction);
}
...
cpumask_of_pcibus( struct pci_bus *bus)
{
 int node;
...
static inline void pci_resource_to_user( struct pci_dev *dev, int bar,
  struct resource *rsrc, resource_size_t *start,
  resource_size_t *end)
{
 *start = rsrc->start;
 *end = rsrc->end;
...
void * *pcim_iomap_table(struct pci_dev *pdev);
int pcim_iomap_regions(struct pci_dev *pdev, int mask, char *name);
...
{
 if ((__builtin_constant_p((0*32+13)) && ( ((((0*32+13))>>5)==0 && (1UL<<(((0*32+13))&31) & ((1<<((0*32+ 0) & 31))|0|(1<<((0*32+ 5) & 31))|(1<<((0*32+ 6) & 31))| (1<<((0*32+ 8) & 31))|0|(1<<((0*32+24) & 31))|(1<<((0*32+15) & 31))| (1<<((0*32+25) & 31))|(1<<((0*32+26) & 31))))) || ((((0*32+13))>>5)==1 && (1UL<<(((0*32+13))&31) & ((1<<((1*32+29) & 31))|0))) || ((((0*32+13))>>5)==2 && (1UL<<(((0*32+13))&31) & 0)) || ((((0*32+13))>>5)==3 && (1UL<<(((0*32+13))&31) & ((1<<((3*32+20) & 31))))) || ((((0*32+13))>>5)==4 && (1UL<<(((0*32+13))&31) & (0))) || ((((0*32+13))>>5)==5 && (1UL<<(((0*32+13))&31) & 0)) || ((((0*32+13))>>5)==6 && (1UL<<(((0*32+13))&31) & 0)) || ((((0*32+13))>>5)==7 && (1UL<<(((0*32+13))&31) & 0)) || ((((0*32+13))>>5)==8 && (1UL<<(((0*32+13))&31) & 0)) || ((((0*32+13))>>5)==9 && (1UL<<(((0*32+13))&31) & 0)) ) ? 1 : (__builtin_constant_p(((0*32+13))) ? constant_test_bit(((0*32+13)), ((unsigned long *)((&boot_cpu_data)->x86_capability))) : variable_test_bit(((0*32+13)), ((unsigned long *)((&boot_cpu_data)->x86_capability))))))
  __flush_tlb_global();
 else
  __flush_tlb();
}
...
extern __attribute__((section(".data..percpu" "..shared_aligned"))) __typeof__(struct tlb_state) cpu_tlbstate __attribute__((__aligned__((1 << (6)))));

static inline void reset_lazy_tlbstate(void)
{
 do { do { void *__vpp_verify = (typeof((&((cpu_tlbstate.state))) + 0))0; (void)__vpp_verify; } while (0); switch(sizeof((cpu_tlbstate.state))) { case 1: do { typedef typeof(((cpu_tlbstate.state))) pto_T__; if (0) { pto_T__ pto_tmp__; pto_tmp__ = ((0)); (void)pto_tmp__; } switch (sizeof(((cpu_tlbstate.state)))) { case 1: asm("mov" "b %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "qi" ((pto_T__)((0)))); break; case 2: asm("mov" "w %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "ri" ((pto_T__)((0)))); break; case 4: asm("mov" "l %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "ri" ((pto_T__)((0)))); break; case 8: asm("mov" "q %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "re" ((pto_T__)((0)))); break; default: __bad_percpu_size(); } } while (0);break; case 2: do { typedef typeof(((cpu_tlbstate.state))) pto_T__; if (0) { pto_T__ pto_tmp__; pto_tmp__ = ((0)); (void)pto_tmp__; } switch (sizeof(((cpu_tlbstate.state)))) { case 1: asm("mov" "b %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "qi" ((pto_T__)((0)))); break; case 2: asm("mov" "w %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "ri" ((pto_T__)((0)))); break; case 4: asm("mov" "l %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "ri" ((pto_T__)((0)))); break; case 8: asm("mov" "q %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "re" ((pto_T__)((0)))); break; default: __bad_percpu_size(); } } while (0);break; case 4: do { typedef typeof(((cpu_tlbstate.state))) pto_T__; if (0) { pto_T__ pto_tmp__; pto_tmp__ = ((0)); (void)pto_tmp__; } switch (sizeof(((cpu_tlbstate.state)))) { case 1: asm("mov" "b %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "qi" ((pto_T__)((0)))); break; case 2: asm("mov" "w %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "ri" ((pto_T__)((0)))); break; case 4: asm("mov" "l %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "ri" ((pto_T__)((0)))); break; case 8: asm("mov" "q %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "re" ((pto_T__)((0)))); break; default: __bad_percpu_size(); } } while (0);break; case 8: do { typedef typeof(((cpu_tlbstate.state))) pto_T__; if (0) { pto_T__ pto_tmp__; pto_tmp__ = ((0)); (void)pto_tmp__; } switch (sizeof(((cpu_tlbstate.state)))) { case 1: asm("mov" "b %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "qi" ((pto_T__)((0)))); break; case 2: asm("mov" "w %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "ri" ((pto_T__)((0)))); break; case 4: asm("mov" "l %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "ri" ((pto_T__)((0)))); break; case 8: asm("mov" "q %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.state))) : "re" ((pto_T__)((0)))); break; default: __bad_percpu_size(); } } while (0);break; default: __bad_size_call_parameter();break; } } while (0);
 do { do { void *__vpp_verify = (typeof((&((cpu_tlbstate.active_mm))) + 0))0; (void)__vpp_verify; } while (0); switch(sizeof((cpu_tlbstate.active_mm))) { case 1: do { typedef typeof(((cpu_tlbstate.active_mm))) pto_T__; if (0) { pto_T__ pto_tmp__; pto_tmp__ = ((&init_mm)); (void)pto_tmp__; } switch (sizeof(((cpu_tlbstate.active_mm)))) { case 1: asm("mov" "b %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "qi" ((pto_T__)((&init_mm)))); break; case 2: asm("mov" "w %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "ri" ((pto_T__)((&init_mm)))); break; case 4: asm("mov" "l %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "ri" ((pto_T__)((&init_mm)))); break; case 8: asm("mov" "q %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "re" ((pto_T__)((&init_mm)))); break; default: __bad_percpu_size(); } } while (0);break; case 2: do { typedef typeof(((cpu_tlbstate.active_mm))) pto_T__; if (0) { pto_T__ pto_tmp__; pto_tmp__ = ((&init_mm)); (void)pto_tmp__; } switch (sizeof(((cpu_tlbstate.active_mm)))) { case 1: asm("mov" "b %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "qi" ((pto_T__)((&init_mm)))); break; case 2: asm("mov" "w %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "ri" ((pto_T__)((&init_mm)))); break; case 4: asm("mov" "l %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "ri" ((pto_T__)((&init_mm)))); break; case 8: asm("mov" "q %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "re" ((pto_T__)((&init_mm)))); break; default: __bad_percpu_size(); } } while (0);break; case 4: do { typedef typeof(((cpu_tlbstate.active_mm))) pto_T__; if (0) { pto_T__ pto_tmp__; pto_tmp__ = ((&init_mm)); (void)pto_tmp__; } switch (sizeof(((cpu_tlbstate.active_mm)))) { case 1: asm("mov" "b %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "qi" ((pto_T__)((&init_mm)))); break; case 2: asm("mov" "w %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "ri" ((pto_T__)((&init_mm)))); break; case 4: asm("mov" "l %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "ri" ((pto_T__)((&init_mm)))); break; case 8: asm("mov" "q %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "re" ((pto_T__)((&init_mm)))); break; default: __bad_percpu_size(); } } while (0);break; case 8: do { typedef typeof(((cpu_tlbstate.active_mm))) pto_T__; if (0) { pto_T__ pto_tmp__; pto_tmp__ = ((&init_mm)); (void)pto_tmp__; } switch (sizeof(((cpu_tlbstate.active_mm)))) { case 1: asm("mov" "b %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "qi" ((pto_T__)((&init_mm)))); break; case 2: asm("mov" "w %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "ri" ((pto_T__)((&init_mm)))); break; case 4: asm("mov" "l %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "ri" ((pto_T__)((&init_mm)))); break; case 8: asm("mov" "q %1,""%%""gs"":" "%P" "0" : "+m" (((cpu_tlbstate.active_mm))) : "re" ((pto_T__)((&init_mm)))); break; default: __bad_percpu_size(); } } while (0);break; default: __bad_size_call_parameter();break; } } while (0);
}
...
extern void probe_roms(void);
 ...
 void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) x86_64_start_kernel(char *real_mode);
 void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) x86_64_start_reservations(char *real_mode_data);
...
static inline void pmd_populate_kernel(struct mm_struct *mm,
           pmd_t *pmd, pte_t *pte)
{
 paravirt_alloc_pte(mm, __phys_addr_nodebug((unsigned long)(pte)) >> 12);
 set_pmd(pmd, __pmd(__phys_addr_nodebug((unsigned long)(pte)) | ((((pteval_t)(1)) << 0) | (((pteval_t)(1)) << 1) | (((pteval_t)(1)) << 2) | (((pteval_t)(1)) << 5) | (((pteval_t)(1)) << 6))));
}
...
{
 struct page *page;
 page = alloc_pages(((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)) | (( gfp_t)0x400u) | (( gfp_t)0x8000u), 0);
 if (!page)
  return 0;
 ...
 return (pmd_t *)lowmem_page_address(page);
}

static inline void pmd_free(struct mm_struct *mm, pmd_t *pmd)
{
 ((unsigned long)pmd & (((1UL) << 12)-1));
 pgtable_pmd_page_dtor((((struct page *)(0xffffea0000000000UL)) + (__phys_addr_nodebug((unsigned long)(pmd)) >> 12)));
...
{
 paravirt_alloc_pmd(mm, __phys_addr_nodebug((unsigned long)(pmd)) >> 12);
 set_pud(pud, __pud(((((pteval_t)(1)) << 0) | (((pteval_t)(1)) << 1) | (((pteval_t)(1)) << 2) | (((pteval_t)(1)) << 5) | (((pteval_t)(1)) << 6)) | __phys_addr_nodebug((unsigned long)(pmd))));
}
...
{
 paravirt_alloc_pud(mm, __phys_addr_nodebug((unsigned long)(pud)) >> 12);
 set_pgd(pgd, __pgd(((((pteval_t)(1)) << 0) | (((pteval_t)(1)) << 1) | (((pteval_t)(1)) << 2) | (((pteval_t)(1)) << 5) | (((pteval_t)(1)) << 6)) | __phys_addr_nodebug((unsigned long)(pud))));
}
