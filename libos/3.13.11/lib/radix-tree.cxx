...
struct radix_tree_preload {
 int nr;
 struct radix_tree_node *nodes[((((((8 * sizeof(unsigned long))) + ((0 ? 4 : 6)) - 1) / ((0 ? 4 : 6)))) * 2 - 1)];
};
static __attribute__((section(".data..percpu" ""))) __typeof__(struct radix_tree_preload) radix_tree_preloads = { 0, };
...
{
 return root->gfp_mask & (( gfp_t)((1 << 25) - 1));
}
...
{
 root->gfp_mask &= (( gfp_t)((1 << 25) - 1));
}

static inline int root_tag_get(struct radix_tree_root *root, unsigned int tag)
{
 return ( unsigned)root->gfp_mask & (1 << (tag + 25));
}
