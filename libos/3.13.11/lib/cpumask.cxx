...
int __first_cpu( cpumask_t *srcp)
{
 return ({ int __min1 = (256); int __min2 = (find_first_bit(srcp->bits, 256)); __min1 < __min2 ? __min1: __min2; });
}
;

int __next_cpu(int n, cpumask_t *srcp)
{
 return ({ int __min1 = (256); int __min2 = (find_next_bit(srcp->bits, 256, n+1)); __min1 < __min2 ? __min1: __min2; });
}
;
...
int __next_cpu_nr(int n, cpumask_t *srcp)
{
 return ({ int __min1 = (nr_cpu_ids); int __min2 = (find_next_bit(srcp->bits, nr_cpu_ids, n+1)); __min1 < __min2 ? __min1: __min2; })
                                               ;
}
;
       ...
       struct cpumask *src2p)
{
 while ((n = cpumask_next(n, src1p)) < nr_cpu_ids)
  if ((__builtin_constant_p((cpumask_check(n))) ? constant_test_bit((cpumask_check(n)), ((((src2p))->bits))) : variable_test_bit((cpumask_check(n)), ((((src2p))->bits)))))
   break;
 return n;
}
;
