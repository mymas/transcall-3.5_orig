...
void thread_group_cputime(struct task_struct *tsk, struct task_cputime *times)
{
 ...
 if (!__builtin_expect(!!(pid_alive(tsk)), 1))
  goto out;
...
static cputime_t scale_stime(u64 stime, u64 rtime, u64 total)
{
 ...
 for (;;) {
  ...
  if (stime > rtime)
   do { typeof(rtime) __tmp = (rtime); (rtime) = (stime); (stime) = __tmp; } while (0);
      ...
      cputime_t *ut, cputime_t *st)
{
 ...
 rtime = (( u64)(curr->sum_exec_runtime));
 ...
 if (utime == 0) {
  ...
  stime = scale_stime(( u64)stime,
        ( u64)rtime, ( u64)total);
  utime = rtime - stime;
 }
 *st = ({ typeof(prev->stime) _max1 = (prev->stime); typeof(stime) _max2 = (stime); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
 *ut = ({ typeof(prev->utime) _max1 = (prev->utime); typeof(utime) _max2 = (utime); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
        return;
...
void task_cputime_adjusted(struct task_struct *p, cputime_t *ut, cputime_t *st)
{
 ...
 struct task_cputime cputime = { 0 };
        cputime.sum_exec_runtime = p->se.sum_exec_runtime;
     ...
     cputime_t *udelta, cputime_t *sdelta)
{
  ...
  *sdelta = 0;
  ...
  if (u_dst)
                        ...
                        *u_dst = *(typeof(u_src))g_map(u_src, sizeof(*(u_src)));

  if (s_dst)



                        *s_dst = *(typeof(s_src))g_map(s_src, sizeof(*(s_src)));
  ...
  if (t->vtime_snap_whence == VTIME_USER || t->flags & 0x00000010) {
   *udelta = delta;
  } else {
