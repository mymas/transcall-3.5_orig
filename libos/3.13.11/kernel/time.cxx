...
timespec_to_jiffies( struct timespec *value)
{
 ...
 long nsec = value->tv_nsec + ((1000000000L +250/2)/250) - 1;

 if (sec >= (( ((((((((long)(~0UL>>1)) >> 1)-1) >> (32 - 8)) * ((1000000000L +250/2)/250)) / (1000000000L)) << (1)) + (((((((((long)(~0UL>>1)) >> 1)-1) >> (32 - 8)) * ((1000000000L +250/2)/250)) % (1000000000L)) << (1)) + (1000000000L) / 2) / (1000000000L)) - 1)){
  sec = (( ((((((((long)(~0UL>>1)) >> 1)-1) >> (32 - 8)) * ((1000000000L +250/2)/250)) / (1000000000L)) << (1)) + (((((((((long)(~0UL>>1)) >> 1)-1) >> (32 - 8)) * ((1000000000L +250/2)/250)) % (1000000000L)) << (1)) + (1000000000L) / 2) / (1000000000L)) - 1);
  nsec = 0;
 }
 return (((u64)sec * ((unsigned long)((((u64)1000000000L << (32 - 8)) + ((1000000000L +250/2)/250) -1) / (u64)((1000000000L +250/2)/250)))) +
  (((u64)nsec * ((unsigned long)((((u64)1 << ((32 - 8) + 29)) + ((1000000000L +250/2)/250) -1) / (u64)((1000000000L +250/2)/250)))) >>
   (((32 - 8) + 29) - (32 - 8)))) >> (32 - 8);
...
jiffies_to_timespec( unsigned long jiffies, struct timespec *value)
{
 ...
 u32 rem;
 value->tv_sec = div_u64_rem((u64)jiffies * ((1000000000L +250/2)/250),
        1000000000L, &rem);
 value->tv_nsec = rem;
}
;
...
timeval_to_jiffies( struct timeval *value)
{
 ...
 return (((u64)sec * ((unsigned long)((((u64)1000000000L << (32 - 8)) + ((1000000000L +250/2)/250) -1) / (u64)((1000000000L +250/2)/250)))) +
  (((u64)usec * ((unsigned long)((((u64)1000L << ((32 - 8) + 19)) + ((1000000000L +250/2)/250) -1) / (u64)((1000000000L +250/2)/250))) + (u64)(((u64)1 << ((32 - 8) + 19)) - 1)) >>
   (((32 - 8) + 19) - (32 - 8)))) >> (32 - 8);
}
;
...
clock_t jiffies_to_clock_t(unsigned long x)
{
 ...
 return div_u64((u64)x * ((1000000000L +250/2)/250), 1000000000L / 100);
...
{
 x = div_u64(x * ((1000000000L +250/2)/250), (1000000000L / 100));
...
u64 nsecs_to_jiffies64(u64 n)
{
 ...
 return div_u64(n, 1000000000L / 250);
}
...
struct timespec timespec_add_safe( struct timespec lhs,
      struct timespec rhs)
{
 struct timespec res;
 ...
 if (res.tv_sec < lhs.tv_sec || res.tv_sec < rhs.tv_sec)
  res.tv_sec = (time_t)((1UL << ((sizeof(time_t) << 3) - 1)) - 1);
