...
static inline struct timespec tk_xtime(struct _timekeeper *tk)
{
 struct timespec ts;
...
extern void update_vsyscall(struct _timekeeper *tk);
...
extern void __hardpps( struct timespec *, struct timespec *);
extern void tk_debug_account_sleep_time(struct timespec *t);
extern struct _timekeeper timekeeper;
...
static inline s64 timekeeping_get_ns(struct _timekeeper *tk)

{
 ...
 s64 nsec;
        cycle_now = jiffies;
        cycle_delta = (cycle_now - 0) & 0xffffffff;
...
ktime_t ktime_get(void)
{
 ...
 struct _timekeeper *tk = &timekeeper;
 ...
 return ({ ({ ktime_t var; var.tv64 = (ktime_set(secs, 0)).tv64 + (nsecs); var; }); });
}
;
