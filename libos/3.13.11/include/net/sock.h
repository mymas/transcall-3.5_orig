...
#ifndef NOTC
#define sk_shutdown sk_state2.sk_shutdown
#define sk_no_check sk_state2.sk_no_check
#define sk_userlocks sk_state2.sk_userlocks
#define sk_protocol sk_state2.sk_protocol
#define sk_type sk_state2.sk_type
    } sk_state2;
#endif
	int			sk_wmem_queued;
	gfp_t			sk_allocation;
...
#else
	int x = (waitall ? len : min_t(int, sk->sk_rcvlowat, len));
        return x ? x : 1;
#endif
}
