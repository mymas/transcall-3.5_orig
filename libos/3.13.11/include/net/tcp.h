...
#else
	return tp->keepalive_probes ? tp->keepalive_probes : sysctl_tcp_keepalive_probes;
#endif
}
...
#else
		__tcp_push_pending_frames(sk, tcp_current_mss(sk), tp->ts_nonagle);
#endif
	}
}
...
#else
	return tp->notsent_lowat ? tp->notsent_lowat : sysctl_tcp_notsent_lowat;
#endif
}
