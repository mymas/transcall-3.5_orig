...
static u64 get_idle_time(int cpu)
{
 ...
 if ((__builtin_constant_p((cpumask_check((cpu)))) ? constant_test_bit((cpumask_check((cpu))), ((((cpu_online_mask))->bits))) : variable_test_bit((cpumask_check((cpu))), ((((cpu_online_mask))->bits)))))
  idle_time = get_cpu_idle_time_us(cpu, 0);

 if (idle_time == -1ULL)

  idle = (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })).cpustat[CPUTIME_IDLE];
 else
  idle = ( cputime64_t)((idle_time) * 1000L);
...
static u64 get_iowait_time(int cpu)
{
 ...
 if ((__builtin_constant_p((cpumask_check((cpu)))) ? constant_test_bit((cpumask_check((cpu))), ((((cpu_online_mask))->bits))) : variable_test_bit((cpumask_check((cpu))), ((((cpu_online_mask))->bits)))))
  iowait_time = get_cpu_iowait_time_us(cpu, 0);

 if (iowait_time == -1ULL)

  iowait = (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })).cpustat[CPUTIME_IOWAIT];
 else
  iowait = ( cputime64_t)((iowait_time) * 1000L);
...
int show_stat(struct seq_file *p, void *v)
{
 ...
 for (((i)) = -1; ((i)) = cpumask_next(((i)), (cpu_possible_mask)), ((i)) < nr_cpu_ids;) {
  user += (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[i])))); }); })).cpustat[CPUTIME_USER];
  nice += (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[i])))); }); })).cpustat[CPUTIME_NICE];
  system += (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[i])))); }); })).cpustat[CPUTIME_SYSTEM];
  idle += get_idle_time(i);
  iowait += get_iowait_time(i);
  irq += (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[i])))); }); })).cpustat[CPUTIME_IRQ];
  softirq += (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[i])))); }); })).cpustat[CPUTIME_SOFTIRQ];
  steal += (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[i])))); }); })).cpustat[CPUTIME_STEAL];
  guest += (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[i])))); }); })).cpustat[CPUTIME_GUEST];
  guest_nice += (*({ do { void *__vpp_verify = (typeof(((&(kernel_cpustat))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))); (typeof((typeof(*(&(kernel_cpustat))) *)(&(kernel_cpustat)))) (__ptr + (((__per_cpu_offset[i])))); }); })).cpustat[CPUTIME_GUEST_NICE];
 ...
 seq_puts(p, "cpu ");
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)user, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)nice, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)system, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)idle, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)iowait, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)irq, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)softirq, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)steal, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)guest, (1000000000L / 100)));
 seq_put_decimal_ull(p, ' ', div_u64(( u64)( cputime_t)guest_nice, (1000000000L / 100)));
 seq_putc(p, '\n');
