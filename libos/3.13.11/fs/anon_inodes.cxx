...
struct file *anon_inode_getfile( char *name,
    struct file_operations *fops,
    void *priv, int flags);
int anon_inode_getfd( char *name, struct file_operations *fops,
       void *priv, int flags);
char *anon_inodefs_dname(struct dentry *dentry, char *buffer, int buflen)
{
