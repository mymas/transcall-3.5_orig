...
int seq_vprintf(struct seq_file *m, char *f, va_list args)
{
 int len;
...
;
struct hlist_node *
seq_hlist_start_percpu(struct hlist_head *head, int *cpu, loff_t pos)
{
 struct hlist_node *node;

 for (((*cpu)) = -1; ((*cpu)) = cpumask_next(((*cpu)), (cpu_possible_mask)), ((*cpu)) < nr_cpu_ids;) {
  for (node = (({ do { void *__vpp_verify = (typeof((((head))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((head))) *)((head)))); (typeof((typeof(*((head))) *)((head)))) (__ptr + (((__per_cpu_offset[(*cpu)])))); }); }))->first; node ; node = node->next) {
   if (pos-- == 0)
    return node;
  }
 }
...
;
struct hlist_node *
seq_hlist_next_percpu(void *v, struct hlist_head *head,
   int *cpu, loff_t *pos)
{
 struct hlist_node *node = v;
 ...
 for (*cpu = cpumask_next(*cpu, cpu_possible_mask); *cpu < nr_cpu_ids;
  ...
  struct hlist_head *bucket = ({ do { void *__vpp_verify = (typeof((((head))) + 0))0; (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((head))) *)((head)))); (typeof((typeof(*((head))) *)((head)))) (__ptr + (((__per_cpu_offset[(*cpu)])))); }); });
