...
void get_vmalloc_info(struct vmalloc_info *vmi)
{
 ...
 prev_end = (0xffffc90000000000UL);

 ;

 if (list_empty(&vmap_area_list)) {
  vmi->largest_chunk = ((0xffffe8ffffffffffUL) - (0xffffc90000000000UL));
  goto out;
 }

 for (va = ({ typeof( ((typeof(*va) *)0)->list ) *__mptr = ((&vmap_area_list)->next); (typeof(*va) *)( (char *)__mptr - ((size_t) &((typeof(*va) *)0)->list) );}); &va->list != (&vmap_area_list); va = ({ typeof( ((typeof(*(va)) *)0)->list ) *__mptr = ((va)->list.next); (typeof(*(va)) *)( (char *)__mptr - ((size_t) &((typeof(*(va)) *)0)->list) );})) {
 ...
 if ((0xffffe8ffffffffffUL) - prev_end > vmi->largest_chunk)
  vmi->largest_chunk = (0xffffe8ffffffffffUL) - prev_end;
