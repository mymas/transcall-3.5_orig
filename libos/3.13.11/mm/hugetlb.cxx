...
{
 return get_current()->flags & 0x01000000;
}

static inline int cpuset_do_slab_mem_spread(void)
{
 return get_current()->flags & 0x02000000;
}
...
static inline void set_mems_allowed(nodemask_t nodemask)
{
 ...
 ;
 ;
 get_current()->mems_allowed = nodemask;
 ;
 ;
 ;
}
...
struct page *alloc_migrate_target(struct page *page, unsigned long _private,
    int **resultp);
...
extern void hugetlb_cgroup_uncharge_cgroup(int idx, unsigned long nr_pages,
        struct hugetlb_cgroup *h_cg);
extern void hugetlb_cgroup_file_init(void) __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) ;
...
static inline void get_page_foll(struct page *page)
{
 if (__builtin_expect(!!(PageTail(page)), 0))
  ...
  __get_page_tail_foll(page, _true);
 else {
        ...
        struct page *page)
{
 ...
 if (__builtin_expect(!!((vma->vm_flags & (0x00002000 | (0x00004000 | 0x00040000 | 0x00000400 | 0x10000000))) != 0x00002000), 1))
  return 0;
...
static inline struct page *mem_map_offset(struct page *base, int offset)
{
 if (__builtin_expect(!!(offset >= (1 << (11 - 1))), 0))
  return (((struct page *)(0xffffea0000000000UL)) + ((unsigned long)((base) - ((struct page *)(0xffffea0000000000UL))) + offset));
 return base + offset;
}
      ...
      struct page *base, int offset)
{
 if (__builtin_expect(!!((offset & ((1 << (11 - 1)) - 1)) == 0), 0)) {
  unsigned long pfn = (unsigned long)((base) - ((struct page *)(0xffffea0000000000UL))) + offset;
  if (!pfn_valid(pfn))
   return 0;
  return (((struct page *)(0xffffea0000000000UL)) + (pfn));
 }
 return iter + 1;
}
enum mminit_level {
...
{
 struct hstate *h = &(hstates[default_hstate_idx]);
 seq_printf(m,
   "HugePages_Total:   %5lu\n"
   "HugePages_Free:    %5lu\n"
   "HugePages_Rsvd:    %5lu\n"
