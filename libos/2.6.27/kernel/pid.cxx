...
struct user_namespace {
 struct kref kref;
 struct hlist_head uidhash_table[(1 << (0 ? 3 : 8))];
...
struct pid *find_pid_ns(int nr, struct pid_namespace *ns)
{
 ...
 struct upid *pnr;
        ...
        struct hlist_head *head = &pid_hash[hash_64((unsigned long)nr + (unsigned long)ns, pidhash_shift)];
        int level = ns->level;
        ...
        for (elem = ((head)->first); elem && ({ __builtin_prefetch(elem->next); 1; }) && ({ pnr = ({ typeof( ((typeof(*pnr) *)0)->pid_chain ) *__mptr = (elem); (typeof(*pnr) *)( (char *)__mptr - ((size_t) &((typeof(*pnr) *)0)->pid_chain) );}); 1; }); elem = (elem->next))
...
extern typeof(find_pid_ns) find_pid_ns; static char __kstrtab_find_pid_ns[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_pid_ns"; static struct kernel_symbol __ksymtab_find_pid_ns __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&find_pid_ns, __kstrtab_find_pid_ns };
struct task_struct *pid_task(struct pid *pid, enum pid_type type)
{
 struct task_struct *result = 0;
 if (pid) {
  struct hlist_node *first;
  ...
  if (first)
   result = ({ typeof( ((struct task_struct *)0)->pids[(type)].node ) *__mptr = (first); (struct task_struct *)( (char *)__mptr - ((size_t) &((struct task_struct *)0)->pids[(type)].node) );});
 }
 return result;
}
extern typeof(pid_task) pid_task; static char __kstrtab_pid_task[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "pid_task"; static struct kernel_symbol __ksymtab_pid_task __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&pid_task, __kstrtab_pid_task };
  ...
  struct pid_namespace *ns)
{
 ...
 return pid_task(find_pid_ns(nr, ns), (enum pid_type)type);

}

extern typeof(find_task_by_pid_type_ns) find_task_by_pid_type_ns; static char __kstrtab_find_task_by_pid_type_ns[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_task_by_pid_type_ns"; static struct kernel_symbol __ksymtab_find_task_by_pid_type_ns __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_task_by_pid_type_ns, __kstrtab_find_task_by_pid_type_ns };

struct task_struct *find_task_by_vpid(pid_t vnr)
{
 return find_task_by_pid_type_ns(PIDTYPE_PID, vnr,
   get_current()->nsproxy->pid_ns);
}
extern typeof(find_task_by_vpid) find_task_by_vpid; static char __kstrtab_find_task_by_vpid[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_task_by_vpid"; static struct kernel_symbol __ksymtab_find_task_by_vpid __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_task_by_vpid, __kstrtab_find_task_by_vpid };

struct task_struct *find_task_by_pid_ns(pid_t nr, struct pid_namespace *ns)
{
 return find_task_by_pid_type_ns(PIDTYPE_PID, nr, ns);
}
extern typeof(find_task_by_pid_ns) find_task_by_pid_ns; static char __kstrtab_find_task_by_pid_ns[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_task_by_pid_ns"; static struct kernel_symbol __ksymtab_find_task_by_pid_ns __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_task_by_pid_ns, __kstrtab_find_task_by_pid_ns };
...
pid_t pid_vnr(struct pid *pid)
{
 return pid_nr_ns(pid, get_current()->nsproxy->pid_ns);
}
extern typeof(pid_vnr) pid_vnr; static char __kstrtab_pid_vnr[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "pid_vnr"; static struct kernel_symbol __ksymtab_pid_vnr __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&pid_vnr, __kstrtab_pid_vnr };

pid_t task_pid_nr_ns(struct task_struct *tsk, struct pid_namespace *ns)
{
 return pid_nr_ns(task_pid(tsk), ns);
}
extern typeof(task_pid_nr_ns) task_pid_nr_ns; static char __kstrtab_task_pid_nr_ns[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "task_pid_nr_ns"; static struct kernel_symbol __ksymtab_task_pid_nr_ns __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&task_pid_nr_ns, __kstrtab_task_pid_nr_ns };

pid_t task_tgid_nr_ns(struct task_struct *tsk, struct pid_namespace *ns)
{
 return pid_nr_ns(task_tgid(tsk), ns);
}
extern typeof(task_tgid_nr_ns) task_tgid_nr_ns; static char __kstrtab_task_tgid_nr_ns[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "task_tgid_nr_ns"; static struct kernel_symbol __ksymtab_task_tgid_nr_ns __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&task_tgid_nr_ns, __kstrtab_task_tgid_nr_ns };

pid_t task_pgrp_nr_ns(struct task_struct *tsk, struct pid_namespace *ns)
{
 return pid_nr_ns(task_pgrp(tsk), ns);
}
extern typeof(task_pgrp_nr_ns) task_pgrp_nr_ns; static char __kstrtab_task_pgrp_nr_ns[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "task_pgrp_nr_ns"; static struct kernel_symbol __ksymtab_task_pgrp_nr_ns __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&task_pgrp_nr_ns, __kstrtab_task_pgrp_nr_ns };
...
extern typeof(task_session_nr_ns) task_session_nr_ns; static char __kstrtab_task_session_nr_ns[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "task_session_nr_ns"; static struct kernel_symbol __ksymtab_task_session_nr_ns __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&task_session_nr_ns, __kstrtab_task_session_nr_ns };
