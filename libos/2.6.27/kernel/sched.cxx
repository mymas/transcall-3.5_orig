...
int cgroup_is_removed( struct cgroup *cgrp);
...
int cgroup_is_descendant( struct cgroup *cgrp);
...
static inline void
cgroup_mm_owner_callbacks(struct task_struct *old, struct task_struct *_new)
{
}
...
struct dentry *debugfs_create_file( char *name, mode_t mode,
       struct dentry *parent, void *data,
       struct file_operations *fops);
...
struct dentry *debugfs_create_u8( char *name, mode_t mode,
     struct dentry *parent, u8 *value);
struct dentry *debugfs_create_u16( char *name, mode_t mode,
      struct dentry *parent, u16 *value);
struct dentry *debugfs_create_u32( char *name, mode_t mode,
      struct dentry *parent, u32 *value);
struct dentry *debugfs_create_u64( char *name, mode_t mode,
      struct dentry *parent, u64 *value);
struct dentry *debugfs_create_x8( char *name, mode_t mode,
     struct dentry *parent, u8 *value);
struct dentry *debugfs_create_x16( char *name, mode_t mode,
      struct dentry *parent, u16 *value);
struct dentry *debugfs_create_x32( char *name, mode_t mode,
      struct dentry *parent, u32 *value);
struct dentry *debugfs_create_bool( char *name, mode_t mode,
      struct dentry *parent, u32 *value);

struct dentry *debugfs_create_blob( char *name, mode_t mode,
...
struct cpupri {
 ...
 long pri_active[((((100 + 2)) + (8 * sizeof(long)) - 1) / (8 * sizeof(long)))];
 int cpu_to_pri[64];
};
...
static struct list_head task_groups = { &(task_groups), &(task_groups) };
...
struct rq {
 ...
 unsigned int bkl_count;
           ...
           extern __attribute__((__section__(".data.percpu.shared_aligned"))) __typeof__(struct rq) per_cpu__runqueues __attribute__((__aligned__((1 << (7)))));
...
unsigned long nr_running(void)
{
 ...
 for (((i)) = -1; ((i)) = __next_cpu((((i))), &((cpu_online_map))), ((i)) < 64; )
  sum += (&(*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__runqueues))); (typeof((&per_cpu__runqueues))) (__ptr + (((((_cpu_pda[(i)])->data_offset))))); })))->nr_running;
...
unsigned long long nr_context_switches(void)
{
 ...
 for (((i)) = -1; ((i)) = __next_cpu((((i))), &((cpu_possible_map))), ((i)) < 64; )
  sum += (&(*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__runqueues))); (typeof((&per_cpu__runqueues))) (__ptr + (((((_cpu_pda[(i)])->data_offset))))); })))->nr_switches;
...
unsigned long nr_iowait(void)
{
 ...
 for (((i)) = -1; ((i)) = __next_cpu((((i))), &((cpu_possible_map))), ((i)) < 64; )
  sum += ((&((&(*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__runqueues))); (typeof((&per_cpu__runqueues))) (__ptr + (((((_cpu_pda[(i)])->data_offset))))); })))->nr_iowait))->counter);

 return sum;
}
cputime_t task_utime(struct task_struct *p)
{
 clock_t utime = jiffies_to_clock_t(p->utime),
  total = utime + jiffies_to_clock_t(p->stime);
 u64 temp;
 ...
 if (total) {
  temp *= utime;
  ({ uint32_t __base = (total); uint32_t __rem; __rem = ((uint64_t)(temp)) % __base; (temp) = ((uint64_t)(temp)) / __base; __rem; });
 }
 utime = (clock_t)temp;


 return ({ typeof(p->prev_utime) _max1 = (p->prev_utime); typeof(clock_t_to_jiffies(utime)) _max2 = (clock_t_to_jiffies(utime)); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
...
cputime_t task_stime(struct task_struct *p)
{
 ...
 stime = nsec_to_clock_t(p->se.sum_exec_runtime) -
   jiffies_to_clock_t(task_utime(p));

 if (stime >= 0)

                return ({ typeof(p->prev_stime) _max1 = (p->prev_stime); typeof(clock_t_to_jiffies(stime)) _max2 = (clock_t_to_jiffies(stime)); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
...
{
 return (((p)->static_prio) - 100 - 20);
}
extern typeof(task_nice) task_nice; static char __kstrtab_task_nice[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "task_nice"; static struct kernel_symbol __ksymtab_task_nice __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&task_nice, __kstrtab_task_nice };
