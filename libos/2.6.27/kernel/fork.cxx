...
extern typeof(mmput) mmput; static char __kstrtab_mmput[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "mmput"; static struct kernel_symbol __ksymtab_mmput __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&mmput, __kstrtab_mmput };
...
extern typeof(get_task_mm) get_task_mm; static char __kstrtab_get_task_mm[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "get_task_mm"; static struct kernel_symbol __ksymtab_get_task_mm __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&get_task_mm, __kstrtab_get_task_mm };
