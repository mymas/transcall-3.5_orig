...
__attribute__((__aligned__((1 << (7))), __section__(".data.cacheline_aligned"))) seqlock_t xtime_lock = { 0, {} };
...
extern typeof(getnstimeofday) getnstimeofday; static char __kstrtab_getnstimeofday[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "getnstimeofday"; static struct kernel_symbol __ksymtab_getnstimeofday __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&getnstimeofday, __kstrtab_getnstimeofday };
...
extern typeof(do_gettimeofday) do_gettimeofday; static char __kstrtab_do_gettimeofday[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "do_gettimeofday"; static struct kernel_symbol __ksymtab_do_gettimeofday __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&do_gettimeofday, __kstrtab_do_gettimeofday };
