...
extern typeof(ktime_get_ts) ktime_get_ts; static char __kstrtab_ktime_get_ts[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "ktime_get_ts"; static struct kernel_symbol __ksymtab_ktime_get_ts __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&ktime_get_ts, __kstrtab_ktime_get_ts };
