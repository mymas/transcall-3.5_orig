...
extern typeof(in_lock_functions) in_lock_functions; static char __kstrtab_in_lock_functions[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "in_lock_functions"; static struct kernel_symbol __ksymtab_in_lock_functions __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&in_lock_functions, __kstrtab_in_lock_functions };
