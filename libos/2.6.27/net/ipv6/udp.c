	...
	if (v == SEQ_START_TOKEN)
		seq_printf(seq,
			   ...
			   "   uid  timeout inode ref pointer drops\n");
                ...
                udp6_sock_seq_show(seq, (struct sock *)v, ((struct udp_iter_state *)seq->private)->bucket);
	return 0;
}

#ifndef NOTC
extern void *udp_seq_start(struct seq_file *seq, loff_t *pos);
extern void udp_seq_stop(struct seq_file *seq, void *v);
extern void *udp_seq_next(struct seq_file *seq, void *v, loff_t *pos);

struct seq_operations udp6_seq_ops = {
    udp_seq_start,
    udp_seq_stop,
    udp_seq_next,
    udp6_seq_show,
...
#ifndef NOTC
void udp6_set_private(struct udp_iter_state *state)
{
