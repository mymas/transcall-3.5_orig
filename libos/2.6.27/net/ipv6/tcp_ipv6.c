...
static int tcp6_seq_show(struct seq_file *seq, void *v)
{
	...
	case TCP_SEQ_STATE_ESTABLISHED:
                get_tcp6_sock(seq, (struct sock *)v, st->num);
		break;
	case TCP_SEQ_STATE_OPENREQ:
                get_openreq6(seq, st->syn_wait_sk, (struct request_sock *)v, st->num, st->uid);
		break;
	case TCP_SEQ_STATE_TIME_WAIT:
                get_timewait6_sock(seq, (struct inet_timewait_sock *)v, st->num);
		break;
	}
out:
	return 0;
...
extern void tcp_seq_stop(struct seq_file *seq, void *v);

struct seq_operations tcp6_seq_ops = {
    tcp_seq_start,
    tcp_seq_stop,
    tcp_seq_next,
    tcp6_seq_show,
...
#ifndef NOTC
void tcp6_set_private(struct tcp_iter_state *state)
{
