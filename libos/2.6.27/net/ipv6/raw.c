...
#else
                raw6_sock_seq_show(seq, (struct sock *)v, raw_seq_private(seq)->bucket);
#endif
	return 0;
}
...
#else
struct seq_operations raw6_seq_ops = {
    raw_seq_start,
    raw_seq_stop,
    raw_seq_next,
    raw6_seq_show,
...
#ifndef NOTC
void raw6_set_private(struct raw_iter_state *state)
{
    state->h = &raw_v6_hashinfo;
}
#endif // !NOTC
