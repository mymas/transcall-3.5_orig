...
extern int compat_sock_get_timestampns(struct sock *, struct timespec *);
...
extern long compat_sys_sendmsg(int,struct compat_msghdr *,unsigned);
extern long compat_sys_recvmsg(int,struct compat_msghdr *,unsigned);
