...
#define tsk_pid 336 /* offsetof(struct task_struct, pid)	# */

#define TI_flags 16 /* offsetof(struct thread_info, flags)	# */
#define TI_addr_limit 40 /* offsetof(struct thread_info, addr_limit)	# */
#define TI_preempt_count 32 /* offsetof(struct thread_info, preempt_count)	# */
#define TI_status 24 /* offsetof(struct thread_info, status)	# */
...
#define PARAVIRT_PATCH_pv_cpu_ops 80 /* offsetof(struct paravirt_patch_template, pv_cpu_ops)	# */
#define PARAVIRT_PATCH_pv_irq_ops 392 /* offsetof(struct paravirt_patch_template, pv_irq_ops)	# */
#define PV_IRQ_irq_disable 24 /* offsetof(struct pv_irq_ops, irq_disable)	# */
#define PV_IRQ_irq_enable 32 /* offsetof(struct pv_irq_ops, irq_enable)	# */
#define PV_IRQ_adjust_exception_frame 56 /* offsetof(struct pv_irq_ops, adjust_exception_frame)	# */
#define PV_CPU_iret 280 /* offsetof(struct pv_cpu_ops, iret)	# */
#define PV_CPU_usergs_sysret32 272 /* offsetof(struct pv_cpu_ops, usergs_sysret32)	# */
#define PV_CPU_usergs_sysret64 264 /* offsetof(struct pv_cpu_ops, usergs_sysret64)	# */
#define PV_CPU_irq_enable_sysexit 256 /* offsetof(struct pv_cpu_ops, irq_enable_sysexit)	# */
#define PV_CPU_swapgs 288 /* offsetof(struct pv_cpu_ops, swapgs)	# */
#define PV_MMU_read_cr2 16 /* offsetof(struct pv_mmu_ops, read_cr2)	# */
...
#define __NR_syscall_max 294 /* sizeof(syscalls) - 1	# */
