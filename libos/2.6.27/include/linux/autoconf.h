...
#define CONFIG_IWLCORE_MODULE 1
...
#define CONFIG_IWL3945_RFKILL 1
...
#define CONFIG_B43LEGACY_RFKILL 1
...
#define CONFIG_DVB_SIANO_SMS1XXX_MODULE 1
#define CONFIG_DVB_SIANO_SMS1XXX_SMS_IDS 1
