...
int __first_cpu( cpumask_t *srcp)
{
 return ({ int __min1 = (64); int __min2 = (find_first_bit(srcp->bits, 64)); __min1 < __min2 ? __min1: __min2; });
}
extern typeof(__first_cpu) __first_cpu; static char __kstrtab___first_cpu[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__first_cpu"; static struct kernel_symbol __ksymtab___first_cpu __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__first_cpu, __kstrtab___first_cpu };

int __next_cpu(int n, cpumask_t *srcp)
{
 return ({ int __min1 = (64); int __min2 = (find_next_bit(srcp->bits, 64, n+1)); __min1 < __min2 ? __min1: __min2; });
}
extern typeof(__next_cpu) __next_cpu; static char __kstrtab___next_cpu[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__next_cpu"; static struct kernel_symbol __ksymtab___next_cpu __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__next_cpu, __kstrtab___next_cpu };
int __any_online_cpu( cpumask_t *mask)
{
 int cpu;

 for ((cpu) = -1; (cpu) = __next_cpu(((cpu)), &((*mask))), (cpu) < 64; ) {
  if ((__builtin_constant_p((((cpu)))) ? constant_test_bit((((cpu))), ((cpu_online_map).bits)) : variable_test_bit((((cpu))), ((cpu_online_map).bits))))
   break;
 }
 return cpu;
}
extern typeof(__any_online_cpu) __any_online_cpu; static char __kstrtab___any_online_cpu[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__any_online_cpu"; static struct kernel_symbol __ksymtab___any_online_cpu __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__any_online_cpu, __kstrtab___any_online_cpu };
