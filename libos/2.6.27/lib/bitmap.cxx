...
extern typeof(__bitmap_empty) __bitmap_empty; static char __kstrtab___bitmap_empty[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_empty"; static struct kernel_symbol __ksymtab___bitmap_empty __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_empty, __kstrtab___bitmap_empty };
...
extern typeof(__bitmap_full) __bitmap_full; static char __kstrtab___bitmap_full[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_full"; static struct kernel_symbol __ksymtab___bitmap_full __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_full, __kstrtab___bitmap_full };
...
extern typeof(__bitmap_equal) __bitmap_equal; static char __kstrtab___bitmap_equal[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_equal"; static struct kernel_symbol __ksymtab___bitmap_equal __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_equal, __kstrtab___bitmap_equal };
...
extern typeof(__bitmap_complement) __bitmap_complement; static char __kstrtab___bitmap_complement[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_complement"; static struct kernel_symbol __ksymtab___bitmap_complement __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_complement, __kstrtab___bitmap_complement };
...
extern typeof(__bitmap_shift_right) __bitmap_shift_right; static char __kstrtab___bitmap_shift_right[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_shift_right"; static struct kernel_symbol __ksymtab___bitmap_shift_right __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_shift_right, __kstrtab___bitmap_shift_right };
...
extern typeof(__bitmap_shift_left) __bitmap_shift_left; static char __kstrtab___bitmap_shift_left[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_shift_left"; static struct kernel_symbol __ksymtab___bitmap_shift_left __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_shift_left, __kstrtab___bitmap_shift_left };

void __bitmap_and(unsigned long *dst, unsigned long *bitmap1,
    unsigned long *bitmap2, int bits)
{
 int k;
...
extern typeof(__bitmap_and) __bitmap_and; static char __kstrtab___bitmap_and[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_and"; static struct kernel_symbol __ksymtab___bitmap_and __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_and, __kstrtab___bitmap_and };
...
extern typeof(__bitmap_or) __bitmap_or; static char __kstrtab___bitmap_or[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_or"; static struct kernel_symbol __ksymtab___bitmap_or __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_or, __kstrtab___bitmap_or };
...
extern typeof(__bitmap_xor) __bitmap_xor; static char __kstrtab___bitmap_xor[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_xor"; static struct kernel_symbol __ksymtab___bitmap_xor __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_xor, __kstrtab___bitmap_xor };

void __bitmap_andnot(unsigned long *dst, unsigned long *bitmap1,
    unsigned long *bitmap2, int bits)
{
 int k;
 int nr = (((bits) + (8 * sizeof(long)) - 1) / (8 * sizeof(long)));
...
extern typeof(__bitmap_andnot) __bitmap_andnot; static char __kstrtab___bitmap_andnot[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_andnot"; static struct kernel_symbol __ksymtab___bitmap_andnot __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_andnot, __kstrtab___bitmap_andnot };
...
extern typeof(__bitmap_intersects) __bitmap_intersects; static char __kstrtab___bitmap_intersects[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_intersects"; static struct kernel_symbol __ksymtab___bitmap_intersects __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_intersects, __kstrtab___bitmap_intersects };
...
extern typeof(__bitmap_subset) __bitmap_subset; static char __kstrtab___bitmap_subset[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_subset"; static struct kernel_symbol __ksymtab___bitmap_subset __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_subset, __kstrtab___bitmap_subset };
...
extern typeof(__bitmap_weight) __bitmap_weight; static char __kstrtab___bitmap_weight[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_weight"; static struct kernel_symbol __ksymtab___bitmap_weight __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_weight, __kstrtab___bitmap_weight };
...
extern typeof(bitmap_scnprintf) bitmap_scnprintf; static char __kstrtab_bitmap_scnprintf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_scnprintf"; static struct kernel_symbol __ksymtab_bitmap_scnprintf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_scnprintf, __kstrtab_bitmap_scnprintf };
...
{
 unsigned int nr_nibbles = (((nr_bits)+((typeof(nr_bits))(4)-1))&~((typeof(nr_bits))(4)-1)) / 4;
 return nr_nibbles + (((nr_nibbles)+((typeof(nr_nibbles))(32 / 4)-1))&~((typeof(nr_nibbles))(32 / 4)-1)) / (32 / 4) - 1;
}
  ...
  int nmaskbits)
{
 ...
 do {
  ...
  while (buflen) {
   old_c = c;
   if (is_user) {
    if (({ long __gu_err; unsigned long __gu_val; do { __gu_err = 0; (void)0; switch ((sizeof(*(ubuf++)))) { case 1: asm ("1:	mov""b"" %2,%""b""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	xor""b"" %""b""1,%""b""1\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " " ".balign 8" " " "\n" " " ".quad" " " "1b" "," "3b" "\n" " .previous\n" : "=r" (__gu_err), "=q"(__gu_val) : "m" ((*(struct __large_struct *)(((ubuf++))))), "i" (-14), "0" (__gu_err)); break; case 2: asm ("1:	mov""w"" %2,%""w""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	xor""w"" %""w""1,%""w""1\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " " ".balign 8" " " "\n" " " ".quad" " " "1b" "," "3b" "\n" " .previous\n" : "=r" (__gu_err), "=r"(__gu_val) : "m" ((*(struct __large_struct *)(((ubuf++))))), "i" (-14), "0" (__gu_err)); break; case 4: asm ("1:	mov""l"" %2,%""k""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	xor""l"" %""k""1,%""k""1\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " " ".balign 8" " " "\n" " " ".quad" " " "1b" "," "3b" "\n" " .previous\n" : "=r" (__gu_err), "=r"(__gu_val) : "m" ((*(struct __large_struct *)(((ubuf++))))), "i" (-14), "0" (__gu_err)); break; case 8: asm ("1:	mov""q"" %2,%""""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	xor""q"" %""""1,%""""1\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " " ".balign 8" " " "\n" " " ".quad" " " "1b" "," "3b" "\n" " .previous\n" : "=r" (__gu_err), "=r"(__gu_val) : "m" ((*(struct __large_struct *)(((ubuf++))))), "i" (-14), "0" (__gu_err)); break; default: (__gu_val) = __get_user_bad(); } } while (0); ((c)) = ( __typeof__(*((ubuf++))))__gu_val; __gu_err; }))
     return -14;
   }
   else
    c = *buf++;
   ...
   chunk = (chunk << 4) | ((((_ctype[(int)(unsigned char)(c)])&(0x04)) != 0) ? (c - '0') : (__toupper(c) - 'A' + 10));
   ndigits++; totaldigits++;
  }
  if (ndigits == 0)
   return -22;
...
extern typeof(__bitmap_parse) __bitmap_parse; static char __kstrtab___bitmap_parse[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__bitmap_parse"; static struct kernel_symbol __ksymtab___bitmap_parse __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__bitmap_parse, __kstrtab___bitmap_parse };
int bitmap_parse_user( char *ubuf,
   unsigned int ulen, unsigned long *maskp,
   int nmaskbits)
{
 if (!(__builtin_expect(!!(({ unsigned long flag, roksum; (void)0; asm("add %3,%1 ; sbb %0,%0 ; cmp %1,%4 ; sbb $0,%0" : "=&r" (flag), "=r" (roksum) : "1" (ubuf), "g" ((long)(ulen)), "rm" (current_thread_info()->addr_limit.seg)); flag; }) == 0), 1)))
  return -14;
 return __bitmap_parse(( char *)ubuf, ulen, 1, maskp, nmaskbits);
}
extern typeof(bitmap_parse_user) bitmap_parse_user; static char __kstrtab_bitmap_parse_user[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_parse_user"; static struct kernel_symbol __ksymtab_bitmap_parse_user __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_parse_user, __kstrtab_bitmap_parse_user };
...
extern typeof(bitmap_scnlistprintf) bitmap_scnlistprintf; static char __kstrtab_bitmap_scnlistprintf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_scnlistprintf"; static struct kernel_symbol __ksymtab_bitmap_scnlistprintf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_scnlistprintf, __kstrtab_bitmap_scnlistprintf };
int bitmap_parselist( char *bp, unsigned long *maskp, int nmaskbits)
{
 ...
 bitmap_zero(maskp, nmaskbits);
 do {
  if (!(((_ctype[(int)(unsigned char)(*bp)])&(0x04)) != 0))
   return -22;
  b = a = simple_strtoul(bp, (char **)&bp, 10);
  if (*bp == '-') {
   bp++;
   if (!(((_ctype[(int)(unsigned char)(*bp)])&(0x04)) != 0))
    return -22;
...
extern typeof(bitmap_parselist) bitmap_parselist; static char __kstrtab_bitmap_parselist[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_parselist"; static struct kernel_symbol __ksymtab_bitmap_parselist __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_parselist, __kstrtab_bitmap_parselist };
...
static int bitmap_ord_to_pos( unsigned long *buf, int ord, int bits)
{
 int pos = 0;
...
extern typeof(bitmap_remap) bitmap_remap; static char __kstrtab_bitmap_remap[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_remap"; static struct kernel_symbol __ksymtab_bitmap_remap __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_remap, __kstrtab_bitmap_remap };
...
extern typeof(bitmap_bitremap) bitmap_bitremap; static char __kstrtab_bitmap_bitremap[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_bitremap"; static struct kernel_symbol __ksymtab_bitmap_bitremap __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_bitremap, __kstrtab_bitmap_bitremap };
...
extern typeof(bitmap_onto) bitmap_onto; static char __kstrtab_bitmap_onto[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_onto"; static struct kernel_symbol __ksymtab_bitmap_onto __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_onto, __kstrtab_bitmap_onto };
...
extern typeof(bitmap_fold) bitmap_fold; static char __kstrtab_bitmap_fold[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_fold"; static struct kernel_symbol __ksymtab_bitmap_fold __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_fold, __kstrtab_bitmap_fold };
enum {
 REG_OP_ISFREE,
 REG_OP_ALLOC,
 REG_OP_RELEASE,
...
extern typeof(bitmap_find_free_region) bitmap_find_free_region; static char __kstrtab_bitmap_find_free_region[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_find_free_region"; static struct kernel_symbol __ksymtab_bitmap_find_free_region __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_find_free_region, __kstrtab_bitmap_find_free_region };
void bitmap_release_region(unsigned long *bitmap, int pos, int order)
{
 __reg_op(bitmap, pos, order, REG_OP_RELEASE);
}
extern typeof(bitmap_release_region) bitmap_release_region; static char __kstrtab_bitmap_release_region[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_release_region"; static struct kernel_symbol __ksymtab_bitmap_release_region __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_release_region, __kstrtab_bitmap_release_region };
...
extern typeof(bitmap_allocate_region) bitmap_allocate_region; static char __kstrtab_bitmap_allocate_region[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "bitmap_allocate_region"; static struct kernel_symbol __ksymtab_bitmap_allocate_region __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&bitmap_allocate_region, __kstrtab_bitmap_allocate_region };
