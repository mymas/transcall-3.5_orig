...
int strnicmp( char *s1, char *s2, size_t len)
{
...
extern typeof(strnicmp) strnicmp; static char __kstrtab_strnicmp[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strnicmp"; static struct kernel_symbol __ksymtab_strnicmp __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strnicmp, __kstrtab_strnicmp };
...
extern typeof(strcasecmp) strcasecmp; static char __kstrtab_strcasecmp[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strcasecmp"; static struct kernel_symbol __ksymtab_strcasecmp __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strcasecmp, __kstrtab_strcasecmp };
...
extern typeof(strncasecmp) strncasecmp; static char __kstrtab_strncasecmp[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strncasecmp"; static struct kernel_symbol __ksymtab_strncasecmp __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strncasecmp, __kstrtab_strncasecmp };
char *strcpy(char *dest, char *src)
{
 char *tmp = dest;
...
extern typeof(strcpy) strcpy; static char __kstrtab_strcpy[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strcpy"; static struct kernel_symbol __ksymtab_strcpy __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strcpy, __kstrtab_strcpy };
...
extern typeof(strncpy) strncpy; static char __kstrtab_strncpy[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strncpy"; static struct kernel_symbol __ksymtab_strncpy __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strncpy, __kstrtab_strncpy };
...
extern typeof(strlcpy) strlcpy; static char __kstrtab_strlcpy[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strlcpy"; static struct kernel_symbol __ksymtab_strlcpy __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strlcpy, __kstrtab_strlcpy };
char *strcat(char *dest, char *src)
{
 char *tmp = dest;
...
extern typeof(strcat) strcat; static char __kstrtab_strcat[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strcat"; static struct kernel_symbol __ksymtab_strcat __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strcat, __kstrtab_strcat };
...
extern typeof(strncat) strncat; static char __kstrtab_strncat[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strncat"; static struct kernel_symbol __ksymtab_strncat __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strncat, __kstrtab_strncat };
size_t strlcat(char *dest, char *src, size_t count)
{
...
extern typeof(strlcat) strlcat; static char __kstrtab_strlcat[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strlcat"; static struct kernel_symbol __ksymtab_strlcat __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strlcat, __kstrtab_strlcat };
int strcmp( char *cs, char *ct)
{
 signed char __res;
...
extern typeof(strcmp) strcmp; static char __kstrtab_strcmp[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strcmp"; static struct kernel_symbol __ksymtab_strcmp __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strcmp, __kstrtab_strcmp };
int strncmp( char *cs, char *ct, size_t count)
{
 signed char __res = 0;
...
extern typeof(strncmp) strncmp; static char __kstrtab_strncmp[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strncmp"; static struct kernel_symbol __ksymtab_strncmp __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strncmp, __kstrtab_strncmp };
...
extern typeof(strchr) strchr; static char __kstrtab_strchr[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strchr"; static struct kernel_symbol __ksymtab_strchr __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strchr, __kstrtab_strchr };
...
extern typeof(strrchr) strrchr; static char __kstrtab_strrchr[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strrchr"; static struct kernel_symbol __ksymtab_strrchr __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strrchr, __kstrtab_strrchr };
char *strnchr( char *s, size_t count, int c)
{
 for (; count-- && *s != '\0'; ++s)
  if (*s == (char)c)
   return (char *)s;
...
extern typeof(strnchr) strnchr; static char __kstrtab_strnchr[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strnchr"; static struct kernel_symbol __ksymtab_strnchr __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strnchr, __kstrtab_strnchr };
 ...
 *(end + 1) = '\0';
 ...
 while (*s && (((_ctype[(int)(unsigned char)(*s)])&(0x20)) != 0))
  s++;

 return s;
}
extern typeof(strstrip) strstrip; static char __kstrtab_strstrip[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strstrip"; static struct kernel_symbol __ksymtab_strstrip __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strstrip, __kstrtab_strstrip };
...
extern typeof(strlen) strlen; static char __kstrtab_strlen[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strlen"; static struct kernel_symbol __ksymtab_strlen __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strlen, __kstrtab_strlen };
...
extern typeof(strnlen) strnlen; static char __kstrtab_strnlen[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strnlen"; static struct kernel_symbol __ksymtab_strnlen __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strnlen, __kstrtab_strnlen };
...
extern typeof(strspn) strspn; static char __kstrtab_strspn[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strspn"; static struct kernel_symbol __ksymtab_strspn __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strspn, __kstrtab_strspn };
...
extern typeof(strcspn) strcspn; static char __kstrtab_strcspn[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strcspn"; static struct kernel_symbol __ksymtab_strcspn __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strcspn, __kstrtab_strcspn };
...
extern typeof(strpbrk) strpbrk; static char __kstrtab_strpbrk[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strpbrk"; static struct kernel_symbol __ksymtab_strpbrk __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strpbrk, __kstrtab_strpbrk };
...
extern typeof(strsep) strsep; static char __kstrtab_strsep[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strsep"; static struct kernel_symbol __ksymtab_strsep __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strsep, __kstrtab_strsep };
bool sysfs_streq( char *s1, char *s2)
{
 while (*s1 && *s1 == *s2) {
  s1++;
  s2++;
...
extern typeof(sysfs_streq) sysfs_streq; static char __kstrtab_sysfs_streq[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "sysfs_streq"; static struct kernel_symbol __ksymtab_sysfs_streq __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&sysfs_streq, __kstrtab_sysfs_streq };
...
extern typeof(memset) memset; static char __kstrtab_memset[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "memset"; static struct kernel_symbol __ksymtab_memset __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&memset, __kstrtab_memset };
...
extern typeof(memcpy) memcpy; static char __kstrtab_memcpy[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "memcpy"; static struct kernel_symbol __ksymtab_memcpy __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&memcpy, __kstrtab_memcpy };
void *memmove(void *dest, void *src, size_t count)
{
 char *tmp;
 char *s;
...
extern typeof(memmove) memmove; static char __kstrtab_memmove[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "memmove"; static struct kernel_symbol __ksymtab_memmove __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&memmove, __kstrtab_memmove };
int memcmp( void *cs, void *ct, size_t count)
{
...
extern typeof(memcmp) memcmp; static char __kstrtab_memcmp[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "memcmp"; static struct kernel_symbol __ksymtab_memcmp __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&memcmp, __kstrtab_memcmp };
...
extern typeof(memscan) memscan; static char __kstrtab_memscan[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "memscan"; static struct kernel_symbol __ksymtab_memscan __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&memscan, __kstrtab_memscan };
...
extern typeof(strstr) strstr; static char __kstrtab_strstr[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strstr"; static struct kernel_symbol __ksymtab_strstr __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strstr, __kstrtab_strstr };
...
extern typeof(memchr) memchr; static char __kstrtab_memchr[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "memchr"; static struct kernel_symbol __ksymtab_memchr __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&memchr, __kstrtab_memchr };
