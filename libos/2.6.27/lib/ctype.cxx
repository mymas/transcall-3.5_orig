...
extern typeof(_ctype) _ctype; static char __kstrtab__ctype[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "_ctype"; static struct kernel_symbol __ksymtab__ctype __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&_ctype, __kstrtab__ctype };
