...
static void __check_printsym_format( char *fmt, ...)
__attribute__((format(printf,1,2)));
static inline void __check_printsym_format( char *fmt, ...)
{
}
...
static inline void print_fn_descriptor_symbol( char *fmt, void *addr)
{
...
unsigned long simple_strtoul( char *cp,char **endp,unsigned int base)
{
 ...
 if (!base) {
  ...
  if (*cp == '0') {
   base = 8;
   cp++;
   if ((((*cp) | 0x20) == 'x') && (((_ctype[(int)(unsigned char)(cp[1])])&(0x04|0x40)) != 0)) {
    cp++;
    base = 16;
   }
  }
 ...
 while ((((_ctype[(int)(unsigned char)(*cp)])&(0x04|0x40)) != 0) &&
        (value = (((_ctype[(int)(unsigned char)(*cp)])&(0x04)) != 0) ? *cp-'0' : ((*cp) | 0x20)-'a'+10) < base) {
...
extern typeof(simple_strtoul) simple_strtoul; static char __kstrtab_simple_strtoul[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "simple_strtoul"; static struct kernel_symbol __ksymtab_simple_strtoul __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&simple_strtoul, __kstrtab_simple_strtoul };
...
long simple_strtol( char *cp,char **endp,unsigned int base)
{
 if(*cp=='-')
...
extern typeof(simple_strtol) simple_strtol; static char __kstrtab_simple_strtol[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "simple_strtol"; static struct kernel_symbol __ksymtab_simple_strtol __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&simple_strtol, __kstrtab_simple_strtol };
...
unsigned long long simple_strtoull( char *cp,char **endp,unsigned int base)
{
...
extern typeof(simple_strtoull) simple_strtoull; static char __kstrtab_simple_strtoull[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "simple_strtoull"; static struct kernel_symbol __ksymtab_simple_strtoull __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&simple_strtoull, __kstrtab_simple_strtoull };
...
long long simple_strtoll( char *cp,char **endp,unsigned int base)
{
 if(*cp=='-')
  return -simple_strtoull(cp+1,endp,base);
 return simple_strtoull(cp,endp,base);
}
int strict_strtoul( char *cp, unsigned int base, unsigned long *res);
int strict_strtol( char *cp, unsigned int base, long *res);
int strict_strtoull( char *cp, unsigned int base, unsigned long long *res);
int strict_strtoll( char *cp, unsigned int base, long long *res);
int strict_strtoul( char *cp, unsigned int base, unsigned long *res){ char *tail; unsigned long val; size_t len; *res = 0; len = strlen(cp); if (len == 0) return -22; val = simple_strtoul(cp, &tail, base); if ((*tail == '\0') || ((len == (size_t)(tail - cp) + 1) && (*tail == '\n'))) { *res = val; return 0; } return -22; }
int strict_strtol( char *cp, unsigned int base, long *res) { int ret; if (*cp == '-') { ret = strict_strtoul(cp+1, base, (unsigned long *)res); if (!ret) *res = -(*res); } else ret = strict_strtoul(cp, base, (unsigned long *)res); return ret; }
int strict_strtoull( char *cp, unsigned int base, unsigned long long *res){ char *tail; unsigned long long val; size_t len; *res = 0; len = strlen(cp); if (len == 0) return -22; val = simple_strtoull(cp, &tail, base); if ((*tail == '\0') || ((len == (size_t)(tail - cp) + 1) && (*tail == '\n'))) { *res = val; return 0; } return -22; }
int strict_strtoll( char *cp, unsigned int base, long long *res) { int ret; if (*cp == '-') { ret = strict_strtoull(cp+1, base, (unsigned long long *)res); if (!ret) *res = -(*res); } else ret = strict_strtoull(cp, base, (unsigned long long *)res); return ret; }

extern typeof(strict_strtoul) strict_strtoul; static char __kstrtab_strict_strtoul[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strict_strtoul"; static struct kernel_symbol __ksymtab_strict_strtoul __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strict_strtoul, __kstrtab_strict_strtoul };
extern typeof(strict_strtol) strict_strtol; static char __kstrtab_strict_strtol[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strict_strtol"; static struct kernel_symbol __ksymtab_strict_strtol __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strict_strtol, __kstrtab_strict_strtol };
extern typeof(strict_strtoll) strict_strtoll; static char __kstrtab_strict_strtoll[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strict_strtoll"; static struct kernel_symbol __ksymtab_strict_strtoll __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strict_strtoll, __kstrtab_strict_strtoll };
extern typeof(strict_strtoull) strict_strtoull; static char __kstrtab_strict_strtoull[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "strict_strtoull"; static struct kernel_symbol __ksymtab_strict_strtoull __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&strict_strtoull, __kstrtab_strict_strtoull };
...
static __attribute__((noinline)) char* put_dec(char *buf, unsigned long long num)
{
 while (1) {
  unsigned rem;
  if (num < 100000)
   return put_dec_trunc(buf, num);
  rem = ({ uint32_t __base = (100000); uint32_t __rem; __rem = ((uint64_t)(num)) % __base; (num) = ((uint64_t)(num)) / __base; __rem; });
...
static char *pointer( char *fmt, char *buf, char *end, void *ptr, int field_width, int precision, int flags)
{
 switch (*fmt) {
 case 'F':
  ptr = (ptr);
...
int vsnprintf(char *buf, size_t size, char *fmt, va_list args)
{
 ...
 if (__builtin_expect(!!((int) size < 0), 0)) {
 ...
 for (; *fmt ; ++fmt) {
  ...
  field_width = -1;
  if ((((_ctype[(int)(unsigned char)(*fmt)])&(0x04)) != 0))
  ...
  switch (*fmt) {
   case 'c':
    ...
    c = (unsigned char) __builtin_va_arg(args,int);
    if (str < end)
     *str = c;
    ++str;
    while (--field_width > 0) {
   ...
   case 's':
    str = string(str, end, __builtin_va_arg(args,char *), field_width, precision, flags);
    continue;
   ...
   case 'n':
     ...
     *ip = (str - buf);
     ...
     size_t * ip = __builtin_va_arg(args,size_t *);
     *ip = (str - buf);
    } else {
  ...
  if (qualifier == 'L')
   num = __builtin_va_arg(args,long long);
  else if (qualifier == 'l') {
   num = __builtin_va_arg(args,unsigned long);
   if (flags & 2)
    num = (signed long) num;
  } else if (qualifier == 'Z' || qualifier == 'z') {
   num = __builtin_va_arg(args,size_t);
  } else if (qualifier == 't') {
   num = __builtin_va_arg(args,ptrdiff_t);
  } else if (qualifier == 'h') {
...
extern typeof(vsnprintf) vsnprintf; static char __kstrtab_vsnprintf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vsnprintf"; static struct kernel_symbol __ksymtab_vsnprintf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vsnprintf, __kstrtab_vsnprintf };
...
extern typeof(vscnprintf) vscnprintf; static char __kstrtab_vscnprintf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vscnprintf"; static struct kernel_symbol __ksymtab_vscnprintf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vscnprintf, __kstrtab_vscnprintf };
...
extern typeof(snprintf) snprintf; static char __kstrtab_snprintf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "snprintf"; static struct kernel_symbol __ksymtab_snprintf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&snprintf, __kstrtab_snprintf };
...
extern typeof(scnprintf) scnprintf; static char __kstrtab_scnprintf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "scnprintf"; static struct kernel_symbol __ksymtab_scnprintf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&scnprintf, __kstrtab_scnprintf };
int vsprintf(char *buf, char *fmt, va_list args)
{
 return vsnprintf(buf, ((int)(~0U>>1)), fmt, args);
}

extern typeof(vsprintf) vsprintf; static char __kstrtab_vsprintf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vsprintf"; static struct kernel_symbol __ksymtab_vsprintf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vsprintf, __kstrtab_vsprintf };
int sprintf(char * buf, char *fmt, ...)
{
 ...
 __builtin_va_start(args,fmt);
 i=vsnprintf(buf, ((int)(~0U>>1)), fmt, args);
 __builtin_va_end(args);
 return i;
}

extern typeof(sprintf) sprintf; static char __kstrtab_sprintf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "sprintf"; static struct kernel_symbol __ksymtab_sprintf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&sprintf, __kstrtab_sprintf };
...
int vsscanf( char * buf, char * fmt, va_list args)
{
 ...
 while(*fmt && *str) {
  ...
  if ((((_ctype[(int)(unsigned char)(*fmt)])&(0x20)) != 0)) {
   while ((((_ctype[(int)(unsigned char)(*fmt)])&(0x20)) != 0))
    ++fmt;
  ...
  if (*fmt == '*') {
   while (!(((_ctype[(int)(unsigned char)(*fmt)])&(0x20)) != 0) && *fmt)
    fmt++;
   while (!(((_ctype[(int)(unsigned char)(*str)])&(0x20)) != 0) && *str)
    str++;
   continue;
  }
  ...
  if (*fmt == 'h' || *fmt == 'l' || *fmt == 'L' ||
      *fmt == 'Z' || *fmt == 'z') {
   qualifier = *fmt++;
   if (__builtin_expect(!!(qualifier == *fmt), 0)) {
    if (qualifier == 'h') {
     qualifier = 'H';
     fmt++;
    } else if (qualifier == 'l') {
  ...
  case 'c':
  {
   char *s = (char *) __builtin_va_arg(args,char*);
   if (field_width == -1)
    field_width = 1;
   do {
    *s++ = *str++;
  ...
  case 's':
  {
   ...
   while (*str && !(((_ctype[(int)(unsigned char)(*str)])&(0x20)) != 0) && field_width--) {
    *s++ = *str++;
   }
   *s = '\0';
   num++;
  ...
  {
   int *i = (int *)__builtin_va_arg(args,int*);
   *i = str - buf;
  }
  continue;
  case 'o':
  ...
  if (!digit
                    || (base == 16 && !(((_ctype[(int)(unsigned char)(digit)])&(0x04|0x40)) != 0))
                    || (base == 10 && !(((_ctype[(int)(unsigned char)(digit)])&(0x04)) != 0))
                    || (base == 8 && (!(((_ctype[(int)(unsigned char)(digit)])&(0x04)) != 0) || digit > '7'))
                    || (base == 0 && !(((_ctype[(int)(unsigned char)(digit)])&(0x04)) != 0)))
    break;

  switch(qualifier) {
  case 'H':
   if (is_sign) {
    signed char *s = (signed char *) __builtin_va_arg(args,signed char *);
    *s = (signed char) simple_strtol(str,&next,base);
   } else {
    unsigned char *s = (unsigned char *) __builtin_va_arg(args,unsigned char *);
    *s = (unsigned char) simple_strtoul(str, &next, base);
   }
   break;
  case 'h':
   if (is_sign) {
    short *s = (short *) __builtin_va_arg(args,short *);
    *s = (short) simple_strtol(str,&next,base);
   } else {
    unsigned short *s = (unsigned short *) __builtin_va_arg(args,unsigned short *);
    *s = (unsigned short) simple_strtoul(str, &next, base);
   }
   break;
  case 'l':
   if (is_sign) {
    long *l = (long *) __builtin_va_arg(args,long *);
    *l = simple_strtol(str,&next,base);
   } else {
    unsigned long *l = (unsigned long*) __builtin_va_arg(args,unsigned long*);
    *l = simple_strtoul(str,&next,base);
   }
   break;
  case 'L':
   if (is_sign) {
    long long *l = (long long*) __builtin_va_arg(args,long long *);
    *l = simple_strtoll(str,&next,base);
   } else {
    unsigned long long *l = (unsigned long long*) __builtin_va_arg(args,unsigned long long*);
  ...
  case 'z':
  {
   size_t *s = (size_t*) __builtin_va_arg(args,size_t*);
  ...
  default:
    ...
    *i = (int) simple_strtol(str,&next,base);
    ...
    unsigned int *i = (unsigned int*) __builtin_va_arg(args,unsigned int*);
 ...
 if (*fmt == '%' && *(fmt + 1) == 'n') {
  int *p = (int *)__builtin_va_arg(args,int *);
  *p = str - buf;
 }
...
extern typeof(vsscanf) vsscanf; static char __kstrtab_vsscanf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vsscanf"; static struct kernel_symbol __ksymtab_vsscanf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vsscanf, __kstrtab_vsscanf };
...
extern typeof(sscanf) sscanf; static char __kstrtab_sscanf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "sscanf"; static struct kernel_symbol __ksymtab_sscanf __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&sscanf, __kstrtab_sscanf };
