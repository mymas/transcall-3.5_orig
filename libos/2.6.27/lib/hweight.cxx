...
extern typeof(hweight32) hweight32; static char __kstrtab_hweight32[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "hweight32"; static struct kernel_symbol __ksymtab_hweight32 __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&hweight32, __kstrtab_hweight32 };
...
extern typeof(hweight16) hweight16; static char __kstrtab_hweight16[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "hweight16"; static struct kernel_symbol __ksymtab_hweight16 __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&hweight16, __kstrtab_hweight16 };
...
extern typeof(hweight8) hweight8; static char __kstrtab_hweight8[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "hweight8"; static struct kernel_symbol __ksymtab_hweight8 __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&hweight8, __kstrtab_hweight8 };
...
extern typeof(hweight64) hweight64; static char __kstrtab_hweight64[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "hweight64"; static struct kernel_symbol __ksymtab_hweight64 __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&hweight64, __kstrtab_hweight64 };
