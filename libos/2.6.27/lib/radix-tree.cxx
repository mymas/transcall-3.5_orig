...
struct radix_tree_node {
 ...
 unsigned long tags[2][(((1UL << (0 ? 4 : 6)) + 64 - 1) / 64)];
};
...
static unsigned long height_to_maxindex[(((((8 * sizeof(unsigned long))) + ((0 ? 4 : 6)) - 1) / ((0 ? 4 : 6)))) + 1] __attribute__((__section__(".data.read_mostly")));
...
struct radix_tree_preload {
 int nr;
 struct radix_tree_node *nodes[(((((8 * sizeof(unsigned long))) + ((0 ? 4 : 6)) - 1) / ((0 ? 4 : 6))))];
};
__attribute__((__section__(".data.percpu"))) __typeof__(struct radix_tree_preload) per_cpu__radix_tree_preloads = { 0, };

static inline gfp_t root_gfp_mask(struct radix_tree_root *root)
{
 return root->gfp_mask & (( gfp_t)((1 << 21) - 1));
}
...
static inline int tag_get(struct radix_tree_node *node, unsigned int tag,
  int offset)
{
 return (__builtin_constant_p((offset)) ? constant_test_bit((offset), (node->tags[tag])) : variable_test_bit((offset), (node->tags[tag])));
}

static inline void root_tag_set(struct radix_tree_root *root, unsigned int tag)
{
 root->gfp_mask |= ( gfp_t)(1 << (tag + 21));
}
...
{
 root->gfp_mask &= (( gfp_t)((1 << 21) - 1));
}

static inline int root_tag_get(struct radix_tree_root *root, unsigned int tag)
{
 return ( unsigned)root->gfp_mask & (1 << (tag + 21));
}
...
{
 int idx;
 for (idx = 0; idx < (((1UL << (0 ? 4 : 6)) + 64 - 1) / 64); idx++) {
...
void **radix_tree_lookup_slot(struct radix_tree_root *root, unsigned long index)
{
 ...
 shift = (height-1) * (0 ? 4 : 6);

 do {
  slot = (struct radix_tree_node **)
   (node->slots + ((index>>shift) & ((1UL << (0 ? 4 : 6))-1)));
  node = (*slot);
  if (node == 0)
   return 0;
...
extern typeof(radix_tree_lookup_slot) radix_tree_lookup_slot; static char __kstrtab_radix_tree_lookup_slot[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "radix_tree_lookup_slot"; static struct kernel_symbol __ksymtab_radix_tree_lookup_slot __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&radix_tree_lookup_slot, __kstrtab_radix_tree_lookup_slot };
...
extern typeof(radix_tree_lookup) radix_tree_lookup; static char __kstrtab_radix_tree_lookup[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "radix_tree_lookup"; static struct kernel_symbol __ksymtab_radix_tree_lookup __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&radix_tree_lookup, __kstrtab_radix_tree_lookup };
