...
extern typeof(find_next_bit) find_next_bit; static char __kstrtab_find_next_bit[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_next_bit"; static struct kernel_symbol __ksymtab_find_next_bit __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_next_bit, __kstrtab_find_next_bit };
...
extern typeof(find_next_zero_bit) find_next_zero_bit; static char __kstrtab_find_next_zero_bit[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_next_zero_bit"; static struct kernel_symbol __ksymtab_find_next_zero_bit __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_next_zero_bit, __kstrtab_find_next_zero_bit };
...
extern typeof(find_first_bit) find_first_bit; static char __kstrtab_find_first_bit[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_first_bit"; static struct kernel_symbol __ksymtab_find_first_bit __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_first_bit, __kstrtab_find_first_bit };
...
extern typeof(find_first_zero_bit) find_first_zero_bit; static char __kstrtab_find_first_zero_bit[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_first_zero_bit"; static struct kernel_symbol __ksymtab_find_first_zero_bit __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_first_zero_bit, __kstrtab_find_first_zero_bit };
