...
extern int kretprobe_blacklist_size;
...
extern __typeof__(struct kprobe *) per_cpu__current_kprobe;
extern __typeof__(struct kprobe_ctlblk) per_cpu__kprobe_ctlblk;
...
{
 return ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__current_kprobe))); (typeof((&per_cpu__current_kprobe))) (__ptr + ((({ typeof(_proxy_pda.data_offset) ret__; switch (sizeof(_proxy_pda.data_offset)) { case 2: asm("mov" "w %%gs:%c1,%0" : "=r" (ret__) : "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; case 4: asm("mov" "l %%gs:%c1,%0": "=r" (ret__): "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; case 8: asm("mov" "q %%gs:%c1,%0": "=r" (ret__) : "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; default: __bad_pda_field(); } ret__; })))); })));
}

static inline void reset_current_kprobe(void)
{
 (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__current_kprobe))); (typeof((&per_cpu__current_kprobe))) (__ptr + ((({ typeof(_proxy_pda.data_offset) ret__; switch (sizeof(_proxy_pda.data_offset)) { case 2: asm("mov" "w %%gs:%c1,%0" : "=r" (ret__) : "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; case 4: asm("mov" "l %%gs:%c1,%0": "=r" (ret__): "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; case 8: asm("mov" "q %%gs:%c1,%0": "=r" (ret__) : "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; default: __bad_pda_field(); } ret__; })))); })) = 0;
}

static inline struct kprobe_ctlblk *get_kprobe_ctlblk(void)
{
 return (&(*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kprobe_ctlblk))); (typeof((&per_cpu__kprobe_ctlblk))) (__ptr + ((({ typeof(_proxy_pda.data_offset) ret__; switch (sizeof(_proxy_pda.data_offset)) { case 2: asm("mov" "w %%gs:%c1,%0" : "=r" (ret__) : "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; case 4: asm("mov" "l %%gs:%c1,%0": "=r" (ret__): "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; case 8: asm("mov" "q %%gs:%c1,%0": "=r" (ret__) : "i" (((size_t) &((struct x8664_pda *)0)->data_offset)), "m" (_proxy_pda.data_offset)); break; default: __bad_pda_field(); } ret__; })))); })));
}
...
extern int __attribute__((warn_unused_result)) __die( char *, struct pt_regs *, long);
extern void show_registers(struct pt_regs *regs);
...
static inline int copy_regset_to_user(struct task_struct *target,
          struct user_regset_view *view,
          unsigned int setno,
          unsigned int offset, unsigned int size,
          void *data)
{
 struct user_regset *regset = &view->regsets[setno];

 if (!(__builtin_expect(!!(({ unsigned long flag, roksum; (void)0; asm("add %3,%1 ; sbb %0,%0 ; cmp %1,%4 ; sbb $0,%0" : "=&r" (flag), "=r" (roksum) : "1" (data), "g" ((long)(size)), "rm" (current_thread_info()->addr_limit.seg)); flag; }) == 0), 1)))
  return -5;

 return regset->get(target, regset, offset, size, 0, data);
}
     ...
     void *data)
{
 ...
 return regset->set(target, regset, offset, size, 0, data);
}
...
extern int save_i387_ia32(struct _fpstate_ia32 *buf);
extern int restore_i387_ia32(struct _fpstate_ia32 *buf);
...
{
 if (__builtin_expect(!!(fx->swd & (1 << 7)), 0))
  asm ("fnclex");
...
{
 if (((struct thread_info *)(tsk)->stack)->status & 0x0001) {
  __save_init_fpu(tsk);
...
{
 if ((__builtin_constant_p((0*32+24)) && ( ((((0*32+24))>>5)==0 && (1UL<<(((0*32+24))&31) & ((1<<((0*32+ 0) & 31))|0|(1<<((0*32+ 5) & 31))|(1<<((0*32+ 6) & 31))| (1<<((0*32+ 8) & 31))|(1<<((0*32+13) & 31))|(1<<((0*32+24) & 31))|(1<<((0*32+15) & 31))| (1<<((0*32+25) & 31))|(1<<((0*32+26) & 31))))) || ((((0*32+24))>>5)==1 && (1UL<<(((0*32+24))&31) & ((1<<((1*32+29) & 31))|0))) || ((((0*32+24))>>5)==2 && (1UL<<(((0*32+24))&31) & 0)) || ((((0*32+24))>>5)==3 && (1UL<<(((0*32+24))&31) & ((1<<((3*32+20) & 31))))) || ((((0*32+24))>>5)==4 && (1UL<<(((0*32+24))&31) & 0)) || ((((0*32+24))>>5)==5 && (1UL<<(((0*32+24))&31) & 0)) || ((((0*32+24))>>5)==6 && (1UL<<(((0*32+24))&31) & 0)) || ((((0*32+24))>>5)==7 && (1UL<<(((0*32+24))&31) & 0)) ) ? 1 : (__builtin_constant_p(((0*32+24))) ? constant_test_bit(((0*32+24)), ((unsigned long *)((&boot_cpu_data)->x86_capability))) : variable_test_bit(((0*32+24)), ((unsigned long *)((&boot_cpu_data)->x86_capability)))))) {
...
{
 if ((__builtin_constant_p((0*32+25)) && ( ((((0*32+25))>>5)==0 && (1UL<<(((0*32+25))&31) & ((1<<((0*32+ 0) & 31))|0|(1<<((0*32+ 5) & 31))|(1<<((0*32+ 6) & 31))| (1<<((0*32+ 8) & 31))|(1<<((0*32+13) & 31))|(1<<((0*32+24) & 31))|(1<<((0*32+15) & 31))| (1<<((0*32+25) & 31))|(1<<((0*32+26) & 31))))) || ((((0*32+25))>>5)==1 && (1UL<<(((0*32+25))&31) & ((1<<((1*32+29) & 31))|0))) || ((((0*32+25))>>5)==2 && (1UL<<(((0*32+25))&31) & 0)) || ((((0*32+25))>>5)==3 && (1UL<<(((0*32+25))&31) & ((1<<((3*32+20) & 31))))) || ((((0*32+25))>>5)==4 && (1UL<<(((0*32+25))&31) & 0)) || ((((0*32+25))>>5)==5 && (1UL<<(((0*32+25))&31) & 0)) || ((((0*32+25))>>5)==6 && (1UL<<(((0*32+25))&31) & 0)) || ((((0*32+25))>>5)==7 && (1UL<<(((0*32+25))&31) & 0)) ) ? 1 : (__builtin_constant_p(((0*32+25))) ? constant_test_bit(((0*32+25)), ((unsigned long *)((&boot_cpu_data)->x86_capability))) : variable_test_bit(((0*32+25)), ((unsigned long *)((&boot_cpu_data)->x86_capability)))))) {
...
struct sigframe32 {
 ...
 unsigned int extramask[(64 / 32)-1];
};
...
unsigned long get_wchan(struct task_struct *p)
{
 ...
 if (p->thread.sp < stack || p->thread.sp >= stack+(((1UL) << 12) << 1))
  return 0;
 fp = *(typeof((u64 *)(p->thread.sp)))g_map((u64 *)(p->thread.sp), sizeof(*((u64 *)(p->thread.sp))));
 do {
  if (fp < (unsigned long)stack ||
      fp >= (unsigned long)stack+(((1UL) << 12) << 1))
   return 0;
  ip = *(typeof((u64 *)(fp+8)))g_map((u64 *)(fp+8), sizeof(*((u64 *)(fp+8))));
  if (!in_sched_functions(ip))
   return ip;
  fp = *(typeof((u64 *)fp))g_map((u64 *)fp, sizeof(*((u64 *)fp)));
 } while (count++ < 16);
 return 0;
}
