...
{
    return (unsigned long)malloc(((1UL) << 12) << order);
}
...
unsigned long copy_to_user(void *to, void *from, unsigned len)
{
    memcpy(to, from, len);
...
unsigned long copy_from_user(void *to, void *from, unsigned len)
{
    memcpy(to, from, len);
...
struct task_struct *get_current(void)
{
    ...
    return ({ typeof( ((struct task_struct *)0)->tasks ) *__mptr = (((&init_task)->tasks.next)); (struct task_struct *)( (char *)__mptr - ((size_t) &((struct task_struct *)0)->tasks) );});
}
...
int uptime_read_proc(char *page, char **start, off_t off, int count, int *eof, void *data); int uptime_proc_show(struct seq_file *m, void *v) { char *start; int eof, size; m->count = uptime_read_proc(m->buf, &start, 0, m->size, &eof, 0); return 0; }
int meminfo_read_proc(char *page, char **start, off_t off, int count, int *eof, void *data); int meminfo_proc_show(struct seq_file *m, void *v) { char *start; int eof, size; m->count = meminfo_read_proc(m->buf, &start, 0, m->size, &eof, 0); return 0; }
int filesystems_read_proc(char *page, char **start, off_t off, int count, int *eof, void *data); int filesystems_proc_show(struct seq_file *m, void *v) { char *start; int eof, size; m->count = filesystems_read_proc(m->buf, &start, 0, m->size, &eof, 0); return 0; }
int version_read_proc(char *page, char **start, off_t off, int count, int *eof, void *data); int version_proc_show(struct seq_file *m, void *v) { char *start; int eof, size; m->count = version_read_proc(m->buf, &start, 0, m->size, &eof, 0); return 0; }
