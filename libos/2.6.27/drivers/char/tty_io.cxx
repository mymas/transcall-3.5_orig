...
int register_con_driver( struct consw *csw, int first, int last);
int unregister_con_driver( struct consw *csw);
int take_over_console( struct consw *sw, int first, int last, int deflt);
...
extern int unbind_con_driver( struct consw *csw, int first, int last,
        int deflt);
int vty_init(void);
...
extern typeof(tty_get_pgrp) tty_get_pgrp; static char __kstrtab_tty_get_pgrp[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "tty_get_pgrp"; static struct kernel_symbol __ksymtab_tty_get_pgrp __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&tty_get_pgrp, __kstrtab_tty_get_pgrp };
dev_t tty_devnum(struct tty_struct *tty)
{
 return (((tty->driver->major) << 20) | (tty->driver->minor_start)) + tty->index;
}
extern typeof(tty_devnum) tty_devnum; static char __kstrtab_tty_devnum[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "tty_devnum"; static struct kernel_symbol __ksymtab_tty_devnum __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&tty_devnum, __kstrtab_tty_devnum };
