 ...
 if (dentry) {
  retval = -38;
   ...
   memset(buf, 0, sizeof(*buf));
                        ...
                        retval = super_op_statfs(dentry->d_sb->s_op,
                                                 dentry, buf);
...
extern typeof(vfs_statfs) vfs_statfs; static char __kstrtab_vfs_statfs[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_statfs"; static struct kernel_symbol __ksymtab_vfs_statfs __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_statfs, __kstrtab_vfs_statfs };




int vfs_statfs_native(struct dentry *dentry, struct statfs *buf)
{
 struct kstatfs st;
 int retval;
