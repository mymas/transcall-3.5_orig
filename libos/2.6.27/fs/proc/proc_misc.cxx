...
static inline int kstat_irqs(int irq)
{
 ...
 for (((cpu)) = -1; ((cpu)) = __next_cpu((((cpu))), &((cpu_possible_map))), ((cpu)) < 64; )
  sum += (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[cpu])->data_offset))))); })).irqs[irq];
...
int hugetlb_sysctl_handler(struct ctl_table *, int, struct file *, void *, size_t *, loff_t *);
int hugetlb_overcommit_handler(struct ctl_table *, int, struct file *, void *, size_t *, loff_t *);
int hugetlb_treat_movable_handler(struct ctl_table *, int, struct file *, void *, size_t *, loff_t *);
...
{
 return ({ typeof( ((struct hugetlbfs_inode_info *)0)->vfs_inode ) *__mptr = (inode); (struct hugetlbfs_inode_info *)( (char *)__mptr - ((size_t) &((struct hugetlbfs_inode_info *)0)->vfs_inode) );});
}
...
struct file *hugetlb_file_setup( char *name, size_t);
...
struct hstate {
 ...
 struct list_head hugepage_freelists[(1 << 9)];
 unsigned int nr_huge_pages_node[(1 << 9)];
 unsigned int free_huge_pages_node[(1 << 9)];
 unsigned int surplus_huge_pages_node[(1 << 9)];
 char name[32];
};
...
{
 return hstate_inode(f->f_path.dentry->d_inode);
}
...
static inline void elf_core_copy_regs(elf_gregset_t *elfregs, struct pt_regs *regs)
{
 ...
 do { unsigned v; ((*elfregs))[0] = (regs)->r15; ((*elfregs))[1] = (regs)->r14; ((*elfregs))[2] = (regs)->r13; ((*elfregs))[3] = (regs)->r12; ((*elfregs))[4] = (regs)->bp; ((*elfregs))[5] = (regs)->bx; ((*elfregs))[6] = (regs)->r11; ((*elfregs))[7] = (regs)->r10; ((*elfregs))[8] = (regs)->r9; ((*elfregs))[9] = (regs)->r8; ((*elfregs))[10] = (regs)->ax; ((*elfregs))[11] = (regs)->cx; ((*elfregs))[12] = (regs)->dx; ((*elfregs))[13] = (regs)->si; ((*elfregs))[14] = (regs)->di; ((*elfregs))[15] = (regs)->orig_ax; ((*elfregs))[16] = (regs)->ip; ((*elfregs))[17] = (regs)->cs; ((*elfregs))[18] = (regs)->flags; ((*elfregs))[19] = (regs)->sp; ((*elfregs))[20] = (regs)->ss; ((*elfregs))[21] = get_current()->thread.fs; ((*elfregs))[22] = get_current()->thread.gs; asm("movl %%ds,%0" : "=r" (v)); ((*elfregs))[23] = v; asm("movl %%es,%0" : "=r" (v)); ((*elfregs))[24] = v; asm("movl %%fs,%0" : "=r" (v)); ((*elfregs))[25] = v; asm("movl %%gs,%0" : "=r" (v)); ((*elfregs))[26] = v; } while (0);
        ...
        struct pt_regs *oldregs)
{
 if (oldregs) {
  ...
  asm ("movq %%rbx,%0" : "=m"(newregs->bx));
  asm ("movq %%rcx,%0" : "=m"(newregs->cx));
  asm ("movq %%rdx,%0" : "=m"(newregs->dx));
  asm ("movq %%rsi,%0" : "=m"(newregs->si));
  asm ("movq %%rdi,%0" : "=m"(newregs->di));
  asm ("movq %%rbp,%0" : "=m"(newregs->bp));
  asm ("movq %%rax,%0" : "=m"(newregs->ax));
  asm ("movq %%rsp,%0" : "=m"(newregs->sp));
  asm ("movq %%r8,%0" : "=m"(newregs->r8));
  asm ("movq %%r9,%0" : "=m"(newregs->r9));
  asm ("movq %%r10,%0" : "=m"(newregs->r10));
  asm ("movq %%r11,%0" : "=m"(newregs->r11));
  asm ("movq %%r12,%0" : "=m"(newregs->r12));
  asm ("movq %%r13,%0" : "=m"(newregs->r13));
  asm ("movq %%r14,%0" : "=m"(newregs->r14));
  asm ("movq %%r15,%0" : "=m"(newregs->r15));
  asm ("movl %%ss, %%eax;" :"=a"(newregs->ss));
  asm ("movl %%cs, %%eax;" :"=a"(newregs->cs));
  asm ("pushfq; popq %0" :"=m"(newregs->flags));
...
relocate_kernel(unsigned long indirection_page,
  ...
  unsigned long start_address) __attribute__((noreturn));
...
extern long sys_kexec_load(unsigned long entry,
     unsigned long nr_segments,
     struct kexec_segment *segments,
     unsigned long flags);
extern int kernel_kexec(void);

extern long compat_sys_kexec_load(unsigned long entry,
    unsigned long nr_segments,
    struct compat_kexec_segment *segments,
    unsigned long flags);
...
void vmcoreinfo_append_str( char *fmt, ...)
 __attribute__ ((format (printf, 1, 2)));
unsigned long paddr_vmcoreinfo_note(void);
extern struct kimage *kexec_image;
extern struct kimage *kexec_crash_image;
extern struct resource crashk_res;
typedef u32 note_buf_t[( ((((sizeof(struct elf64_note))+((typeof(sizeof(struct elf64_note)))(4)-1))&~((typeof(sizeof(struct elf64_note)))(4)-1)) * 2) + (((sizeof("CORE"))+((typeof(sizeof("CORE")))(4)-1))&~((typeof(sizeof("CORE")))(4)-1)) + (((sizeof(struct elf_prstatus))+((typeof(sizeof(struct elf_prstatus)))(4)-1))&~((typeof(sizeof(struct elf_prstatus)))(4)-1)) )/4];
extern note_buf_t *crash_notes;
extern u32 vmcoreinfo_note[((((sizeof(struct elf64_note))+((typeof(sizeof(struct elf64_note)))(4)-1))&~((typeof(sizeof(struct elf64_note)))(4)-1))*2 + (4096) + (((sizeof("VMCOREINFO"))+((typeof(sizeof("VMCOREINFO")))(4)-1))&~((typeof(sizeof("VMCOREINFO")))(4)-1)))/4];
extern size_t vmcoreinfo_size;
extern size_t vmcoreinfo_max_size;

int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) parse_crashkernel(char *cmdline, unsigned long long system_ram,
...
{
 return (elfcorehdr_addr != (-1ULL)) ? 1 : 0;
}
 ...
 *start = page + off;
 ...
 return len;
           ...
           int uptime_read_proc(char *page, char **start, off_t off,
     int count, int *eof, void *data)
{
 struct timespec uptime;
 struct timespec idle;
 int len;
 cputime_t idletime = ((init_task.utime) + (init_task.stime));

 ktime_get_ts(&uptime);
 monotonic_to_bootbased(&uptime);
 jiffies_to_timespec(idletime,&idle);
 len = sprintf(page,"%lu.%02lu %lu.%02lu\n",
   (unsigned long) uptime.tv_sec,
   (uptime.tv_nsec / (1000000000L / 100)),
   (unsigned long) idle.tv_sec,
   (idle.tv_nsec / (1000000000L / 100)));
     ...
     int count, int *eof, void *data)
{
 ...
 cached = global_page_state(NR_FILE_PAGES) -
   swapper_space.nrpages - i.bufferram;
 if (cached < 0)
  cached = 0;
 ...
 len = sprintf(page,
  ...
  ((i.bufferram) << (12 - 10)),
  ((cached) << (12 - 10)),
  ((swapper_space.nrpages) << (12 - 10)),
  ((global_page_state(NR_ACTIVE)) << (12 - 10)),
  ((global_page_state(NR_INACTIVE)) << (12 - 10)),
  ...
  ((allowed) << (12 - 10)),
  ((committed) << (12 - 10)),
  (unsigned long)((0xffffe1ffffffffffUL) - (0xffffc20000000000UL)) >> 10,
  vmi.used >> 10,
 ...
 return proc_calc_metrics(page, start, off, count, eof, len);
           ...
           int version_read_proc(char *page, char **start, off_t off,
     int count, int *eof, void *data)
{
 int len;

 len = snprintf(page, ((1UL) << 12), linux_proc_banner,
  utsname()->sysname,
  utsname()->release,
  utsname()->version);
 return proc_calc_metrics(page, start, off, count, eof, len);
           ...
           int show_stat(struct seq_file *p, void *v)
{
 ...
 per_irq_sum = kzalloc(sizeof(unsigned int)*(256 + (32 * 64)), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!per_irq_sum)
  return -12;

 user = nice = system = idle = iowait =
  irq = softirq = steal = (0ULL);
 guest = (0ULL);
 ...
 for (((i)) = -1; ((i)) = __next_cpu((((i))), &((cpu_possible_map))), ((i)) < 64; ) {
  ...
  user = ((user) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.user));
  nice = ((nice) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.nice));
  system = ((system) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.system));
  idle = ((idle) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.idle));
  iowait = ((iowait) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.iowait));
  irq = ((irq) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.irq));
  softirq = ((softirq) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.softirq));
  steal = ((steal) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.steal));
  guest = ((guest) + ((*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.guest));
  for (j = 0; j < (256 + (32 * 64)); j++) {
   unsigned int temp = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).irqs[j];
   sum += temp;
   per_irq_sum[j] += temp;
  }
 ...
 seq_printf(p, "cpu  %llu %llu %llu %llu %llu %llu %llu %llu %llu\n",
  ...
  (unsigned long long)jiffies_64_to_clock_t(steal),
  (unsigned long long)jiffies_64_to_clock_t(guest));
 for (((i)) = -1; ((i)) = __next_cpu((((i))), &((cpu_online_map))), ((i)) < 64; ) {


  user = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.user;
  nice = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.nice;
  system = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.system;
  idle = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.idle;
  iowait = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.iowait;
  irq = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.irq;
  softirq = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.softirq;
  steal = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.steal;
  guest = (*({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((&per_cpu__kstat))); (typeof((&per_cpu__kstat))) (__ptr + (((((_cpu_pda[i])->data_offset))))); })).cpustat.guest;
  seq_printf(p,
 ...
 return 0;
           ...
           int filesystems_read_proc(char *page, char **start, off_t off,
     int count, int *eof, void *data)
{
