...
{
 if (( EXT3_SB(sb)->s_es->s_feature_ro_compat & (( __le32)(__u32)(0x0001)) )
                                         &&
...
{
 unsigned long metagroup = group / (EXT3_SB(sb)->s_desc_per_block);
 unsigned long first = metagroup * (EXT3_SB(sb)->s_desc_per_block);
 unsigned long last = first + (EXT3_SB(sb)->s_desc_per_block) - 1;
...
unsigned long ext3_bg_num_gdb(struct super_block *sb, int group)
{
 unsigned long first_meta_bg =
   (( __u32)(__le32)(EXT3_SB(sb)->s_es->s_first_meta_bg));
 unsigned long metagroup = group / (EXT3_SB(sb)->s_desc_per_block);

 if (!( EXT3_SB(sb)->s_es->s_feature_incompat & (( __le32)(__u32)(0x0010)) ) ||
