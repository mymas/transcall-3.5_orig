...
struct xattr_handler {
 ...
 int (*get)(struct inode *inode, char *name, void *buffer,
     size_t size);
 int (*set)(struct inode *inode, char *name, void *buffer,
...
extern int ext3_xattr_get(struct inode *, int, char *, void *, size_t);
extern int ext3_xattr_set(struct inode *, int, char *, void *, size_t, int);
extern int ext3_xattr_set_handle(handle_t *, struct inode *, int, char *, void *, size_t, int);
...
void * ext3_follow_link(struct dentry *dentry, struct nameidata *nd)
{
 ...
 nd_set_link(nd, (typeof((char*)ei->i_data))g_map((char*)ei->i_data, sizeof(*((char*)ei->i_data))));
