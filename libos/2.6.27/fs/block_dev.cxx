...
long nr_blockdev_pages(void)
{
 ...
 long ret = 0;
 ;
 for (bdev = ({ typeof( ((typeof(*bdev) *)0)->bd_list ) *__mptr = ((&all_bdevs)->next); (typeof(*bdev) *)( (char *)__mptr - ((size_t) &((typeof(*bdev) *)0)->bd_list) );}); __builtin_prefetch(bdev->bd_list.next), &bdev->bd_list != (&all_bdevs); bdev = ({ typeof( ((typeof(*bdev) *)0)->bd_list ) *__mptr = (bdev->bd_list.next); (typeof(*bdev) *)( (char *)__mptr - ((size_t) &((typeof(*bdev) *)0)->bd_list) );})) {
