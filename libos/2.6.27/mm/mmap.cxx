 ...
 if (mm) {
  ...
  if (!(vma && vma->vm_end > addr && vma->vm_start <= addr)) {
   ...
   while (rb_node) {
    ...
    vma_tmp = ({ typeof( ((struct vm_area_struct *)0)->vm_rb ) *__mptr = (rb_node); (struct vm_area_struct *)( (char *)__mptr - ((size_t) &((struct vm_area_struct *)0)->vm_rb) );})
                                   ;
...
extern typeof(find_vma) find_vma; static char __kstrtab_find_vma[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_vma"; static struct kernel_symbol __ksymtab_find_vma __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_vma, __kstrtab_find_vma };
