...
static inline void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) register_nosave_region(unsigned long b, unsigned long e)
{
 __register_nosave_region(b, e, 0);
}
static inline void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) register_nosave_region_late(unsigned long b, unsigned long e)
{
...
int stop_machine(int (*fn)(void *), void *data, cpumask_t *cpus);
int __stop_machine(int (*fn)(void *), void *data, cpumask_t *cpus);
...
static inline struct page *mem_map_offset(struct page *base, int offset)
{
 if (__builtin_expect(!!(offset >= (1 << (11 - 1))), 0))
  return (((struct page *)(0xffffe20000000000UL)) + (((base) - ((struct page *)(0xffffe20000000000UL))) + offset));
 return base + offset;
}
      ...
      struct page *base, int offset)
{
 if (__builtin_expect(!!((offset & ((1 << (11 - 1)) - 1)) == 0), 0)) {
  unsigned long pfn = ((base) - ((struct page *)(0xffffe20000000000UL))) + offset;
  if (!pfn_valid(pfn))
   return 0;
  return (((struct page *)(0xffffe20000000000UL)) + (pfn));
 }
 return iter + 1;
}
enum mminit_level {
...
extern typeof(si_meminfo) si_meminfo; static char __kstrtab_si_meminfo[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "si_meminfo"; static struct kernel_symbol __ksymtab_si_meminfo __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&si_meminfo, __kstrtab_si_meminfo };
