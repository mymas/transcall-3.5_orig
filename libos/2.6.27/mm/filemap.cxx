...
repeat:
 ...
 if (pagep) {
  ...
  if (__builtin_expect(!!(!page || page == ((void *)-1UL)), 0))
   goto repeat;

  if (!page_cache_get_speculative(page))
   goto repeat;
                if (__builtin_expect(!!(page != *(typeof(pagep))g_map(pagep, sizeof(*(pagep)))), 0)) {
...
extern typeof(find_get_page) find_get_page; static char __kstrtab_find_get_page[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "find_get_page"; static struct kernel_symbol __ksymtab_find_get_page __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&find_get_page, __kstrtab_find_get_page };
